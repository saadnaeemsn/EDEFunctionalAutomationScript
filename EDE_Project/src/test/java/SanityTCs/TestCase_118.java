...
public class TestCase_118 extends BaseTest {
  @Test  public void testCase_118() throws Exception {

		ExtentTestManager.createTest("PTC118", "Partner Test Case 118");
		String tcDataFile = "partner_118.properties";
...
//		commonMethodPage.clickContinueBtn();
		...
		*/
		...
		commonMethodPage.verifyQuestionContents(spanTag, s027Question2, s027QuestionAboutDependents2, 1, 2);
...
//		commonMethodPage.verifyS082(s082Question, s083DrawerHeading, s83DrawerContent);
		commonMethodPage.verifyQuestionContents(spanTag, s082QuestionWI, s082QuestionWI, 1, 2);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.chooseAnOption("I agree", 1, 2);
		commonMethodPage.chooseAnOption("I agree to allow the Marketplace to end the Marketplace coverage for anyone on my application who’s enrolled in both Marketplace and Medicare coverage.", 1, 2);
