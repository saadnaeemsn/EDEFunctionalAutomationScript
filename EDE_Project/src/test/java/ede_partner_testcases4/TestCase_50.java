...
public class TestCase_50  extends BaseTest {
	
	@Test
	public void testCase_50() throws Exception {


		ExtentTestManager.createTest("Test case 50", "Test case 50");
		...
		// Get data from data.properties
				...
				// Get data from testcase_50.properties
				String state = Utility.getDate_TestCase50("state");
				String firstName = Utility.getDate_TestCase50("firstName");
				String lastName = Utility.getDate_TestCase50("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase50("age");
				String firstCousinFirstName = Utility.getDate_TestCase50("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase50("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase50("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase50("streetAddress");
				String city = Utility.getDate_TestCase50("city");
				String zipCode = Utility.getDate_TestCase50("zipCode");
				String county = Utility.getDate_TestCase50("county");
				String phoneNumber = Utility.getDate_TestCase50("phoneNumber");
				String phoneType = Utility.getDate_TestCase50("phoneType");
				String SSN = Utility.getDate_TestCase50("SSN");
				String spouseSSN = Utility.getDate_TestCase50("spouseSSN");
				String childSSN = Utility.getDate_TestCase50("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase50("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase50("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase50("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase50("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase50("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase50("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase50("incomeType");
				String employerName = Utility.getDate_TestCase50("employerName");
				String incomePeriod = Utility.getDate_TestCase50("incomePeriod");
				String coverageType = Utility.getDate_TestCase50("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase50("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase50("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase50("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase50("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase50("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase50("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase50("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase50("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase50("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase50("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase50("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase50("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase50("relationShip");
				String tribeState = Utility.getDate_TestCase50("tribeState");
				String tribe = Utility.getDate_TestCase50("tribe");
				String spouseFirstName = Utility.getDate_TestCase50("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase50("spouseLastName");
				String spouseAge = Utility.getDate_TestCase50("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase50("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase50("gotMarried");
				String childFirstName = Utility.getDate_TestCase50("childFirstName");
				String childLastName = Utility.getDate_TestCase50("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase50("childAge");
				String aiAn = Utility.getDate_TestCase50("aiAn");
				String childRelationShip = Utility.getDate_TestCase50("childRelationShip");
				String plan = Utility.getDate_TestCase50("plan");
				String withoutDocument = Utility.getDate_TestCase50("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase50("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase50("anualPredictedAmount");
				String hours = Utility.getDate_TestCase50("hours");
