...
public class TestCase_30 extends BaseTest {
	@Test
	public void TestCase_30() throws Exception {

		ExtentTestManager.createTest("Test case 30", "Test case 30");
		String tcDataFile = "partner_30.properties";
		...
		String s038Question3 = "Is "+applicantFullName+" the main person taking care of this child (or children)?";
