...
public class TestCase_57  extends BaseTest {
	
	@Test
	public void testCase_57() throws Exception {


		ExtentTestManager.createTest("Test case 57", "Test case 57");
		...
		// Get data from data.properties
				...
				// Get data from testcase_58.properties
				String state = Utility.getDate_TestCase57("state");
				String firstName = Utility.getDate_TestCase57("firstName");
				String lastName = Utility.getDate_TestCase57("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase57("age");
				String streetAddress = Utility.getDate_TestCase57("streetAddress");
				String city = Utility.getDate_TestCase57("city");
				String zipCode = Utility.getDate_TestCase57("zipCode");
				String county = Utility.getDate_TestCase57("county");
				String phoneNumber = Utility.getDate_TestCase57("phoneNumber");
				String phoneType = Utility.getDate_TestCase57("phoneType");
				String SSN = Utility.getDate_TestCase57("SSN");
				String spouseSSN = Utility.getDate_TestCase57("spouseSSN");
				String childSSN = Utility.getDate_TestCase57("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase57("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase57("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase57("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase57("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase57("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase57("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase57("incomeType");
				String employerName = Utility.getDate_TestCase57("employerName");
				String incomePeriod = Utility.getDate_TestCase57("incomePeriod");
				String anotherincomeAmount = Utility.getDate_TestCase57("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase57("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase57("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase57("anotherincomePeriod");
				String jobStartDate = Utility.getDate_TestCase57("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase57("jobEndDate");
				String aiAn = Utility.getDate_TestCase57("aiAn");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase57("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase57("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase57("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase57("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase57("relationShip");
				String tribeState = Utility.getDate_TestCase57("tribeState");
				String tribe = Utility.getDate_TestCase57("tribe");
				String spouseFirstName = Utility.getDate_TestCase57("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase57("spouseLastName");
				String spouseAge = Utility.getDate_TestCase57("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase57("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase57("gotMarried");
				String childFirstName = Utility.getDate_TestCase57("childFirstName");
				String childLastName = Utility.getDate_TestCase57("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase57("childAge");
				String childRelationShip = Utility.getDate_TestCase57("childRelationShip");
				String plan = Utility.getDate_TestCase57("plan");
				String withoutDocument = Utility.getDate_TestCase57("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase57("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase57("anualPredictedAmount");
				String hours = Utility.getDate_TestCase57("hours");
...
//				//commonMethodPage.enterTribeIncomeAmount(anotherincomeAmount);
//				commonMethodPage.clickSaveAndContinueButton();
