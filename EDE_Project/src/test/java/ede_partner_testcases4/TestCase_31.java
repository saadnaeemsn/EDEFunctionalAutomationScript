...
public class TestCase_31 extends BaseTest {
	@Test
	public void TestCase_31() throws Exception {

		ExtentTestManager.createTest("Test case 31", "Test case 31");
		String tcDataFile = "partner_31.properties";
		...
		String s083Question2 = "When did "+applicantFullName+" lose coverage?";
...
//		Wait.wait3Second();
		...
		// Drived or naturalized - 1st Appl
...
//		Wait.wait3Second();
		...
		commonMethodPage.verifyS041A(s041AQuestion, s014DrawerHeading, s014drawerContent);
		...
		// Drived or naturalized - 2nd Appl
		ExtentTestManager.getTest().info("---------------------SCREEN S017----------------------------");
		commonMethodPage.selectNaturalizedOrDrived(no, "", "", "");
		commonMethodPage.clickSaveAndContinueButton();
//				Wait.wait3Second();
...
//		commonMethodPage.selectSitutionHouseHold_S050A();
		...
		commonMethodPage.verifyQuestionContents(spanTag, s083Question2, s083Question2, 1, 1);
		commonMethodPage.enterNSelectOption(inputTag, attrAriaLabel, s083Question2, 1, minus60DaysDate2, 1);
		commonMethodPage.clickSaveAndContinueButton();
