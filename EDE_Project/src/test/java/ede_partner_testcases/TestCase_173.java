...
public class TestCase_173 extends BaseTest {
	@Test
	public void testCase_173() throws Exception {

		ExtentTestManager.createTest("Test case 173", "Test case 173");
		...
		String state = Utility.getDate_TestCase173("state");
		String firstName = Utility.getDate_TestCase173("firstName");
		String lastName = Utility.getDate_TestCase173("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase173("age");
		String streetAddress = Utility.getDate_TestCase173("streetAddress");
		String city = Utility.getDate_TestCase173("city");
		String zipCode = Utility.getDate_TestCase173("zipCode");
		String county = Utility.getDate_TestCase173("county");
		String phoneNumber = Utility.getDate_TestCase173("phoneNumber");
		String phoneType = Utility.getDate_TestCase173("phoneType");
		String relationShip = Utility.getDate_TestCase173("relationShip");
		String daughterFirstName = Utility.getDate_TestCase173("daughterFirstName");
		String daughterLastName = Utility.getDate_TestCase173("daughterLastName");
		String daughterFullName = daughterFirstName + " " + daughterLastName;
		String incomeAmount = Utility.getDate_TestCase173("incomeAmount");
		String incomeType = Utility.getDate_TestCase173("incomeType");
		String employerName = Utility.getDate_TestCase173("employerName");
		String incomePeriod = Utility.getDate_TestCase173("incomePeriod");
		String daughterIncomeAmount = Utility.getDate_TestCase173("daughterIncomeAmount");
		String daughterIncomeType = Utility.getDate_TestCase173("daughterIncomeType");
		String daughterEmployerName = Utility.getDate_TestCase173("daughterEmployerName");
		String daughterIncomePeriod = Utility.getDate_TestCase173("daughterIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase173("EmployerPhone");
		String loseCoverageDate = ESTTimeZone.getPreviousDate("48", "MM/dd/yyyy");
		String daughterAge = Utility.getDate_TestCase173("daughterAge");
