...
public class TestCase_110 extends BaseTest {
  @Test  public void testCase_110() throws Exception {

		ExtentTestManager.createTest("PTC110", "Partner Test Case 110");
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		// Get data from testcase_110.properties
		String tcDataFile = "partner_110.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s046QuestionMedicad8 = Utility.getFromTextProperties("s046QuestionMedicad8") + " " + minus90DaysDate;
		...
		String s057Question2 = "Select a type of income " + childFullName + " "
				+ Utility.getFromTextProperties("s057Question2");
		String s057Question3 = "How often does " + childFullName + " "
		...
		String s074Question = Utility.getFromTextProperties("s074Question") + " " + employerName + " ("+ childFullName + "'s job).";
...
//				commonMethodPage.verifyS038(s038Question2);
		...
		commonMethodPage.verifyS017(s017QuestionSpouse, "", "");
		...
		*/
		...
		// Tax Filer - Income Tax Return
		ExtentTestManager.getTest().info("---------------------SCREEN S028----------------------------");
		commonMethodPage.clickSaveAndContinueButton();
		
		// Sexual Orientation - 3rd Appl
		ExtentTestManager.getTest().info("---------------------SCREEN S042A----------------------------");
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad2, 1);
...
//				commonMethodPage.chooseAnOption(no, 1, 3);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicad8);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
		...
		// Income Questions - 1st Appl - Spouse
		...
		// Applicant Expense - 2nd Appl
		ExtentTestManager.getTest().info("---------------------SCREEN S058----------------------------");
		commonMethodPage.verifyS058(s058QuestionSpouse);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();

		// Income verification - 2nd Appl
		ExtentTestManager.getTest().info("---------------------SCREEN S059----------------------------");
		// calculate monthly income
		Wait.wait2Second();
		commonMethodPage.incomeVerification_S059(yes);
