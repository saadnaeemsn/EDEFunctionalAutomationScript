...
public class TestCase_185 extends BaseTest {
	@Test
	public void testCase_185() throws Exception {

		ExtentTestManager.createTest("Test case 185", "Test case 185");
		...
		// Get data from testcase_185.properties
		String state = Utility.getDate_TestCase185("state");
		String firstName = Utility.getDate_TestCase185("firstName");
		String lastName = Utility.getDate_TestCase185("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase185("age");
		String streetAddress = Utility.getDate_TestCase185("streetAddress");
		String city = Utility.getDate_TestCase185("city");
		String OtherStreetAddress = Utility.getDate_TestCase185("OtherStreetAddress");
		String OtherCity = Utility.getDate_TestCase185("OtherCity");
		String zipCode = Utility.getDate_TestCase185("zipCode");
		String county = Utility.getDate_TestCase185("county");
		String phoneNumber = Utility.getDate_TestCase185("phoneNumber");
		String phoneType = Utility.getDate_TestCase185("phoneType");
		String SSN = Utility.getDate_TestCase185("SSN");
		String spouseSSN = Utility.getDate_TestCase185("spouseSSN");
		String relationShip = Utility.getDate_TestCase185("relationShip");
		String spouseFirstName = Utility.getDate_TestCase185("spouseFirstName");
		String incomeAmount = Utility.getDate_TestCase185("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase185("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_TestCase185("familypremiumAmount");
		String incomeType = Utility.getDate_TestCase185("incomeType");
		String employerName = Utility.getDate_TestCase185("employerName");
		String incomePeriod = Utility.getDate_TestCase185("incomePeriod");
		String spouseAge = Utility.getDate_TestCase185("spouseAge");
		String spouseLastName = Utility.getDate_TestCase185("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String newphewFirstName = Utility.getDate_TestCase185("newphewFirstName");
		String newphewAge = Utility.getDate_TestCase185("newphewAge");
		String newphewLastName = Utility.getDate_TestCase185("newphewLastName");
		String newphewFullName = newphewFirstName + " " + newphewLastName;
		String s050OptionPregnant = Utility.getDate_TestCase185("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase185("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase185("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase185("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase185("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase185("spouseIncomePeriod");
		
		String firstChildIncomeAmount = Utility.getDate_TestCase185("firstChildIncomeAmount");
		String firstChildIncomeType = Utility.getDate_TestCase185("firstChildIncomeType");
		String firstChildEmployerName = Utility.getDate_TestCase185("firstChildEmployerName");
		String firstChildIncomePeriod = Utility.getDate_TestCase185("firstChildIncomePeriod");
		
		String secondChildIncomeAmount = Utility.getDate_TestCase185("secondChildIncomeAmount");
		String secondChildIncomeType = Utility.getDate_TestCase185("secondChildIncomeType");
		String secondChildEmployerName = Utility.getDate_TestCase185("secondChildEmployerName");
		String secondChildIncomePeriod = Utility.getDate_TestCase185("secondChildIncomePeriod");
		
		String EmployerPhone = Utility.getDate_TestCase185("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase185("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase185("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase185("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase185("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase185("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase185("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase185("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase185("childRelationShip");
		String plan = Utility.getDate_TestCase185("plan");
		String brotherRelation = Utility.getDate_TestCase185("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase185("otherRelationShip");
		String parentRelation = Utility.getDate_TestCase185("parentRelation");
		String parentRelationSecond = Utility.getDate_TestCase185("parentRelationSecond");
		...
		Wait.wait3Second();
		commonMethodPage.canYouProvideMoreInfo2_S034(yes);
