...
public class TestCase_188  extends BaseTest {
	
	@Test
	public void testCase_188() throws Exception {


		ExtentTestManager.createTest("Test case 188", "Test case 188");
		...
		// Get data from data.properties
				...
				// Get data from testcase_188.properties
				String state = Utility.getDate_TestCase188("state");
				String firstName = Utility.getDate_TestCase188("firstName");
				String lastName = Utility.getDate_TestCase188("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase188("age");
				String firstCousinFirstName = Utility.getDate_TestCase188("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase188("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase188("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase188("streetAddress");
				String city = Utility.getDate_TestCase188("city");
				String zipCode = Utility.getDate_TestCase188("zipCode");
				String county = Utility.getDate_TestCase188("county");
				String phoneNumber = Utility.getDate_TestCase188("phoneNumber");
				String phoneType = Utility.getDate_TestCase188("phoneType");
				String SSN = Utility.getDate_TestCase188("SSN");
				String spouseSSN = Utility.getDate_TestCase188("spouseSSN");
				String childSSN = Utility.getDate_TestCase188("childSSN");
				String isPregnant = Utility.getDate_TestCase188("isPregnant");
				String babyCount = Utility.getDate_TestCase188("babyCount");
				String domesticPartnerFirstName = Utility.getDate_TestCase188("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase188("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase188("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase188("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase188("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase188("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase188("incomeType");
				String employerName = Utility.getDate_TestCase188("employerName");
				String incomePeriod = Utility.getDate_TestCase188("incomePeriod");
				String coverageType = Utility.getDate_TestCase188("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase188("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase188("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase188("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase188("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase188("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase188("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase188("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase188("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase188("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase188("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase188("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase188("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase188("relationShip");
				String spouseFirstName = Utility.getDate_TestCase188("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase188("spouseLastName");
				String spouseAge = Utility.getDate_TestCase188("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase188("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase188("gotMarried");
				String childFirstName = Utility.getDate_TestCase188("childFirstName");
				String childLastName = Utility.getDate_TestCase188("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase188("childAge");
				String childRelationShip = Utility.getDate_TestCase188("childRelationShip");
				String plan = Utility.getDate_TestCase188("plan");
				String withoutDocument = Utility.getDate_TestCase188("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase188("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase188("anualPredictedAmount");
				String hours = Utility.getDate_TestCase188("hours");
