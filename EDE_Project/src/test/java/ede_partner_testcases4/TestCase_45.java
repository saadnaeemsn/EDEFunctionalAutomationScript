...
public class TestCase_45 extends BaseTest {
	@Test
	public void testCase_45() throws Exception {

		ExtentTestManager.createTest("Test case 45", "Test case 45");
		...
		// Get data from testcase_45.properties
		String state = Utility.getDate_TestCase45("state");
		String firstName = Utility.getDate_TestCase45("firstName");
		String lastName = Utility.getDate_TestCase45("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase45("age");
		String streetAddress = Utility.getDate_TestCase45("streetAddress");
		String city = Utility.getDate_TestCase45("city");
		String OtherStreetAddress = Utility.getDate_TestCase45("otherStreetAddress");
		String OtherCity = Utility.getDate_TestCase45("otherCity");
		String zipCode = Utility.getDate_TestCase45("zipCode");
		String county = Utility.getDate_TestCase45("county");
		String phoneNumber = Utility.getDate_TestCase45("phoneNumber");
		String phoneType = Utility.getDate_TestCase45("phoneType");
		String SSN = Utility.getDate_TestCase45("SSN");
		String spouseSSN = Utility.getDate_TestCase45("spouseSSN");
		String relationShip = Utility.getDate_TestCase45("relationShip");
		String spouseFirstName = Utility.getDate_TestCase45("spouseFirstName");
		String incomeAmount = Utility.getDate_TestCase45("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase45("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_TestCase45("familypremiumAmount");
		String incomeType = Utility.getDate_TestCase45("incomeType");
		String parentSomeOne = Utility.getDate_TestCase45("parentSomeOne");
		String employerName = Utility.getDate_TestCase45("employerName");
		String incomePeriod = Utility.getDate_TestCase45("incomePeriod");
		String spouseAge = Utility.getDate_TestCase45("spouseAge");
		String spouseLastName = Utility.getDate_TestCase45("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String applicantFullAddress = streetAddress + ", " + city + ", " + state + ", " + zipCode;
		String newphewFirstName = Utility.getDate_TestCase45("newphewFirstName");
		String newphewAge = Utility.getDate_TestCase45("newphewAge");
		String newphewLastName = Utility.getDate_TestCase45("newphewLastName");
		String newphewFullName = newphewFirstName + " " + newphewLastName;
		String s050OptionPregnant = Utility.getDate_TestCase45("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase45("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase45("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase45("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase45("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase45("spouseIncomePeriod");
		
		String anotherIncomeAmount = Utility.getDate_TestCase45("anotherIncomeAmount");
		String anotherIncomeType = Utility.getDate_TestCase45("anotherIncomeType");
		String anotherEmployerName = Utility.getDate_TestCase45("anotherEmployerName");
		String anotherIncomePeriod = Utility.getDate_TestCase45("anotherIncomePeriod");
		
		String secondChildIncomeAmount = Utility.getDate_TestCase45("secondChildIncomeAmount");
		String secondChildIncomeType = Utility.getDate_TestCase45("secondChildIncomeType");
		String secondChildEmployerName = Utility.getDate_TestCase45("secondChildEmployerName");
		String secondChildIncomePeriod = Utility.getDate_TestCase45("secondChildIncomePeriod");
		
		String EmployerPhone = Utility.getDate_TestCase45("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase45("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase45("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase45("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase45("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase45("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase45("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase45("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase45("childRelationShip");
		String plan = Utility.getDate_TestCase45("plan");
		String brotherRelation = Utility.getDate_TestCase45("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase45("otherRelationShip");
		String parentRelation = Utility.getDate_TestCase45("parentRelation");
		String parentRelationSecond = Utility.getDate_TestCase45("parentRelationSecond");
		String pragnent = Utility.getDate_TestCase45("pragnent");
		String endDate = Utility.getDate_TestCase45("endDate");
		String predictAmount = Utility.getDate_TestCase45("predictAmount");
		...
		Wait.wait3Second();
		commonMethodPage.applicantTakeCareOfChildrenFirst_S038(firstChildFullName);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.s046EnterDate(endDate);
		commonMethodPage.clickSaveAndContinueButton();
		...
		//commonMethodPage.verifyS046(s046QuestionMedicad, s046QuestionCHIP, s046DrawerHeading, s046DrawerContent);
		Wait.wait3Second();
		commonMethodPage.applyAfterQualifyingLifeEvent_S048(no);
		commonMethodPage.clickSaveAndContinueButton();
		...
		Wait.wait2Second();
		commonMethodPage.enterAnuualPreditedAmount(predictAmount);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait5Second();
