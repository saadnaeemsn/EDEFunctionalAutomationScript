...
public class TestCase_75 extends BaseTest {
	@Test
	public void testCase_75() throws Exception {


		ExtentTestManager.createTest("Test case 75", "Test case 75");
		...
		String state = Utility.getDate_TestCase_75("state");
		String fosterCareState = Utility.getDate_TestCase_75("fosterCareState");
		String firstName = Utility.getDate_TestCase_75("firstName");
		String lastName = Utility.getDate_TestCase_75("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_75("age");
		String streetAddress = Utility.getDate_TestCase_75("streetAddress");
		String city = Utility.getDate_TestCase_75("city");
		String zipCode = Utility.getDate_TestCase_75("zipCode");
		String county = Utility.getDate_TestCase_75("county");
		String phoneNumber = Utility.getDate_TestCase_75("phoneNumber");
		String phoneType = Utility.getDate_TestCase_75("phoneType");
		String SSN = Utility.getDate_TestCase_75("SSN");
		String spouseSSN = Utility.getDate_TestCase_75("spouseSSN");
		String childSSN = Utility.getDate_TestCase_75("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_75("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_75("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_75("domesticPartnerAge");
		String incomeAmount = Utility.getDate_TestCase_75("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase_75("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_75("incomeType");
		String employerName = Utility.getDate_TestCase_75("employerName");
		String incomePeriod = Utility.getDate_TestCase_75("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_75("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_75("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_75("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_75("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_75("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_75("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_75("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_75("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_75("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_75("gotMarried");
		String childFirstName = Utility.getDate_TestCase_75("childFirstName");
		String childLastName = Utility.getDate_TestCase_75("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_75("childAge");
		String childRelationShip = Utility.getDate_TestCase_75("childRelationShip");
		String plan = Utility.getDate_TestCase_75("plan");
		String withoutDocument = Utility.getDate_TestCase_75("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_75("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_75("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_75("hours");
		String leftFosterCareAge = Utility.getDate_TestCase_75("leftFosterCareAge");
		String document = Utility.getDate_TestCase_75("document");
		String documentType = Utility.getDate_TestCase_75("documentType");
