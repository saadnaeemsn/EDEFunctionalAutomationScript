...
public class TestCase_168 extends BaseTest {
	@Test
	public void testCase_168() throws Exception {

		ExtentTestManager.createTest("Test case 168", "Test case 168");
		...
		// Get data from testcase_168.properties
		String state = Utility.getDate_TestCase168("state");
		String firstName = Utility.getDate_TestCase168("firstName");
		String lastName = Utility.getDate_TestCase168("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase168("age");
		String streetAddress = Utility.getDate_TestCase168("streetAddress");
		String city = Utility.getDate_TestCase168("city");
		String zipCode = Utility.getDate_TestCase168("zipCode");
		String county = Utility.getDate_TestCase168("county");
		String phoneNumber = Utility.getDate_TestCase168("phoneNumber");
		String phoneType = Utility.getDate_TestCase168("phoneType");
		String SSN = Utility.getDate_TestCase168("SSN");
		String spouseSSN = Utility.getDate_TestCase168("spouseSSN");
		String relationShip = Utility.getDate_TestCase168("relationShip");
		String spouseFirstName = Utility.getDate_TestCase168("spouseFirstName");
		String spouseAge = Utility.getDate_TestCase168("spouseAge");
		String spouseLastName = Utility.getDate_TestCase168("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase168("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase168("babyCount");
		...
		String incomeAmount = Utility.getDate_TestCase168("incomeAmount");
		String spouseIncomeAmount = Utility.getDate_TestCase168("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase168("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase168("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase168("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase168("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase168("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase168("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase168("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase168("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase168("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase168("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase168("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase168("childRelationShip");
		String plan = Utility.getDate_TestCase168("plan");
		String brotherRelation = Utility.getDate_TestCase168("brotherRelation");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(childRelationShip, brotherRelation, "not applicable", "not applicable",
				"2");
