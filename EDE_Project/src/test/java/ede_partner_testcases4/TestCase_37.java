...
public class TestCase_37 extends BaseTest {
	@Test
	public void TestCase_37() throws Exception {

		ExtentTestManager.createTest("Test case 37", "Test case 37");
		String tcDataFile = "partner_37.properties";
		...
		String brotherFirstName = Utility.getData_TestCase(tcDataFile, "brotherFirstName");
		String brotherLastName = Utility.getData_TestCase(tcDataFile, "brotherLastName");
		String brotherFullName = brotherFirstName + " " + brotherLastName;
		String brotherAge = Utility.getData_TestCase(tcDataFile, "brotherAge");
		...
		String s026QuestionBrother = "What’s" + " " + brotherFullName + "'s" + " " + Utility.getFromTextProperties("s026Question");
		...
		String s027QuestionBrother3 = "Will " + brotherFullName + " " + Utility.getFromTextProperties("s027QuestionSomeOneElseTaxReturn") + " " + ESTTimeZone.getCurrentYear() + "?";
		...
		String s027QuestionBrother = "Does " + brotherFullName + " " + Utility.getFromTextProperties("s027QuestionSingle") + " " + ESTTimeZone.getCurrentYear() + "?";
		...
		String s027QuestionDependentBrother = "Will " + brotherFullName + " " + Utility.getFromTextProperties("s027QuestionDependentSingle") + " " + ESTTimeZone.getCurrentYear() + "?";
		...
		String s038QuestionBrother = "Does " + brotherFullName + " " + Utility.getFromTextProperties("s038Question2");
		...
		String s041Question = "What's "+brotherFullName+"'s home address?";
		...
		String s046Question = null, s049Question = null, s049QuestionBrother = null;
		...
		}else if(state.trim().equalsIgnoreCase("oh")) {
			s046Question = Utility.getFromTextProperties("s046QuestionMedicadOH") + " " + ESTTimeZone.getPreviousDate("90", "MMM d, yyyy") + "?"; ;
		...
		if(state.trim().equalsIgnoreCase("fl")) {
			...
			s049QuestionBrother = "Did " + brotherFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadFL");
		}else if(state.trim().equalsIgnoreCase("mi")) {
			s049Question = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMI");
			s049QuestionBrother = "Did " + brotherFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMI");
		}else if(state.trim().equalsIgnoreCase("de")) {
			s049Question = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadDE");
			s049QuestionBrother = "Did " + brotherFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadDE");
		}else if(state.trim().equalsIgnoreCase("nh")) {
			s049Question = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadNH");
			s049QuestionBrother = "Did " + brotherFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadNH");
		}else if(state.trim().equalsIgnoreCase("oh")) {
			s049Question = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOH");
			s049QuestionBrother = "Did " + brotherFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOH");
		}else if(state.trim().equalsIgnoreCase("az")) {
			s049Question = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
			s049QuestionBrother = "Did " + brotherFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
		}
		...
		String s057Question2Brother = "Select a type of income " + brotherFullName + " " + Utility.getFromTextProperties("s057Question2");
		String s057Question3Brother = "How often does " + brotherFullName + " " + Utility.getFromTextProperties("s057Question3");
		...
		String s058QuestionBrother = "Does " + brotherFullName + " " + Utility.getFromTextProperties("s058Question") + " " + ESTTimeZone.getCurrentYear() + "?";
		...
		String s077Question = Utility.getFromTextProperties("s077Question2");
...
//		commonMethodPage.needCoverage(no, "2");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation(brotherRelationship, "No applicable", "not applicable", "1");
...
//		commonMethodPage.verifyQuestionContents(spanTag, s027Question3, s027Question3, 1, 1);
...
//		Wait.wait2Second();
		...
		// 2nd Appl - SSN
		ExtentTestManager.getTest().info("---------------------SCREEN S012----------------------------");
		commonMethodPage.verifyS012(s012QuestionBrother);
		commonMethodPage.chooseAnOption(brotherFullName + " does not have an SSN.", 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutSsnBtn();

		// 2nd Appl -CitizenShip
		ExtentTestManager.getTest().info("---------------------SCREEN S014----------------------------");
		commonMethodPage.verifyS014(s014QuestionBrother, s014DrawerHeading, s014drawerContent);
		commonMethodPage.selectUSCitizenOrNot(yes);
		commonMethodPage.clickSaveAndContinueButton();
...
//		Wait.wait3Second();
		...
		// Marital status
		ExtentTestManager.getTest().info("---------------------SCREEN S026----------------------------");
		commonMethodPage.verifyS026(s026QuestionBrother, s026DrawerHeading, s026DrawerContent);
		commonMethodPage.selectMaritalStatus(single);
		commonMethodPage.clickSaveAndContinueButton();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S027----------------------------");
//		Wait.wait3Second();
		commonMethodPage.verifyS027(s027QuestionBrother, s027DrawerHeading, s027DrawerContent);
		commonMethodPage.selectIsFilingTax(yes);
		commonMethodPage.verifyS027Dependent(s027QuestionDependentBrother, s027DependentDrawerHeading,s027DependentDrawerContent);
		commonMethodPage.selectIsAnyDependent(no);
//		commonMethodPage.verifyQuestionContents(spanTag, s027QuestionBrother3, s027QuestionBrother3, 1, 1);
		commonMethodPage.chooseAnOption(no, 1, 3);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyS038(s038QuestionSpouse);
		commonMethodPage.verifyQuestionContents(spanTag, s038QuestionBrother, s038QuestionBrother, 1, 1);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.haveMedicaidOrChipEndedOrEndedSoon_S049_P1(no);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s049QuestionBrother, s049QuestionBrother, 1, 1);
		commonMethodPage.chooseAnOption(no, 1, 2);
		commonMethodPage.clickSaveAndContinueButton();
...
//				commonMethodPage.CoverageThroughJobStartingNextMonth_S070(noneOfThese);
		...
		*/
		...
		commonMethodPage.verifyQuestionContents(spanTag, s077Question, s077Question, 2, 1);
		commonMethodPage.clickSaveAndContinueButton();
