...
public class TestCase_20 extends BaseTest {
	...
	public void testCase_20() throws Exception {
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation1_L(childRelationShip,nieceRelation, "not applicable", "not applicable", "1");
		commonMethodPage.clickSaveAndContinueScrolled();
		...
		commonMethodPage.verifyS027QuestionSomeOneElseTaxReturn(s027QuestionDependentbrother);
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation3G_S27(otherUnRelatedRelation, otherUnRelatedRelation, "not applicable",
				"not applicable", "2");
		commonMethodPage.clickSaveAndContinueButton();
		...
		// SSN
		ExtentTestManager.getTest().info("---------------------SCREEN S012----------------------------");
		commonMethodPage.verifyS012(s012QuestionstepDaughter);
		commonMethodPage.clickWithOutSSN();
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutSsnBtn();
