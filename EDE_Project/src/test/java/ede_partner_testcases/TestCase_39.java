...
//		Wait.wait3Second();
		...
		commonMethodPage.selectRelation3G_S27(brotherRelation, "not applicable", "not applicable", "not applicable", "1");
		commonMethodPage.clickSaveAndContinueButton();
...
//		Wait.wait2Second();
		...
		commonMethodPage.selectLiveWithParent_S028(yes);
...
//		Wait.wait2Second();
		...
		// S034 has two questions appeared 
		//S013 apeared after S043 below 
