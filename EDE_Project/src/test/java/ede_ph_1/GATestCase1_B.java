...
public class GATestCase1_B extends BaseTest {
	@Test
	public void GAtestCase1_B() throws Exception {
		...
		String state = Utility.getDate_GATestCase1_B("state");
		String firstName = Utility.getDate_GATestCase1_B("firstName");
		String lastName = Utility.getDate_GATestCase1_B("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_GATestCase1_B("age");
		String streetAddress = Utility.getDate_GATestCase1_B("streetAddress");
		String city = Utility.getDate_GATestCase1_B("city");
		String zipCode = Utility.getDate_GATestCase1_B("zipCode");
		String county = Utility.getDate_GATestCase1_B("county");
		String phoneNumber = Utility.getDate_GATestCase1_B("phoneNumber");
		String phoneType = Utility.getDate_GATestCase1_B("phoneType");
		String document = Utility.getDate_GATestCase1_B("document");
		String SSN = Utility.getDate_GATestCase1_B("SSN");
		String alienNumber = Utility.getDate_GATestCase1_B("alienNumber");
		String naturalizeNumber = Utility.getDate_GATestCase1_B("naturalizeNumber");
		...
		commonMethodPage.haveGAICHRAandQSEHRA_S069D(noneOfThese);
		commonMethodPage.clickSaveAndContinueButton();
