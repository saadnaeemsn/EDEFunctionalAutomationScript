...
public class TestCase_109 extends BaseTest {
  @Test  public void testCase_109() throws Exception {

		ExtentTestManager.createTest("PTC109", "Partner Test Case 109");
...
//		String single = Utility.getValue("single");
		...
		// Get data from testcase_109.properties
		String tcDataFile = "partner_109.properties";
...
//		commonMethodPage.chooseAnOption(noneOfTheseChanges, 1, 1);
		commonMethodPage.chooseAnOption(incarceration, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
