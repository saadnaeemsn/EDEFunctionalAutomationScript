...
public class TestCase_103 extends BaseTest {
	@Test
	public void testCase_103() throws Exception {

		ExtentTestManager.createTest("PTC103", "Partner Test Case 103");
		...
		// Get data from testcase_103.properties
		String state = Utility.getDate_TestCase_103("state");
		String firstName = Utility.getDate_TestCase_103("firstName");
		String lastName = Utility.getDate_TestCase_103("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_103("age");
		String streetAddress = Utility.getDate_TestCase_103("streetAddress");
		String city = Utility.getDate_TestCase_103("city");
		String zipCode = Utility.getDate_TestCase_103("zipCode");
		String county = Utility.getDate_TestCase_103("county");
		String phoneNumber = Utility.getDate_TestCase_103("phoneNumber");
		String phoneType = Utility.getDate_TestCase_103("phoneType");
		String SSN = Utility.getDate_TestCase_103("SSN");
		String spouseSSN = Utility.getDate_TestCase_103("spouseSSN");
		String childSSN = Utility.getDate_TestCase_103("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_103("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_103("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_103("domesticPartnerAge");
		String incomeAmount = Utility.getDate_TestCase_103("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase_103("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_103("incomeType");
		String employerName = Utility.getDate_TestCase_103("employerName");
		String incomePeriod = Utility.getDate_TestCase_103("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_103("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_103("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_103("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_103("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_103("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_103("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_103("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_103("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_103("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_103("gotMarried");
		String childFirstName = Utility.getDate_TestCase_103("childFirstName");
		String childLastName = Utility.getDate_TestCase_103("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_103("childAge");
		String childRelationShip = Utility.getDate_TestCase_103("childRelationShip");
		String plan = Utility.getDate_TestCase_103("plan");
		String withoutDocument = Utility.getDate_TestCase_103("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_103("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_103("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_103("hours");
...
//		commonMethodPage.clickSaveAndContinueButton();
		...
		//Question about recent moved not asked 
