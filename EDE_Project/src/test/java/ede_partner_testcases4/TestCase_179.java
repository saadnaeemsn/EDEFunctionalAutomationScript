...
public class TestCase_179 extends BaseTest {
	...
	public void TestCase_179() throws Exception {
		...
		String tcDataFile = "partner_179.properties";
		...
		String s058QuestionChild = "Does " + childFullName + " " + Utility.getFromTextProperties("s058Question") + " " + ESTTimeZone.getCurrentYear() + "?";
...
//		commonMethodPage.refreshPage();
		...
		*/
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S038----------------------------");
//				 commonMethodPage.verifyS038(s038Question);
		commonMethodPage.verifyQuestionContents(spanTag, s038QuestionChild, s038QuestionChild, 1, 1);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//				Wait.wait3Second();
		...
		commonMethodPage.chooseAnOption(death, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s010BQuestion2, s010BQuestion2, 1, 1);
		commonMethodPage.chooseAnOption(death, 1, 1);
		commonMethodPage.enterNSelectOption(inputTag, attrAriaLabel, dateOfDeath, 1, todayDate2, 1);
		commonMethodPage.clickSaveAndContinueButton();
