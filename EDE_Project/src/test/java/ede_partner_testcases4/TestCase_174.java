...
public class TestCase_174 extends BaseTest {
  @Test  public void testCase_174() throws Exception {

		ExtentTestManager.createTest("PTC174", "Partner Test Case 174");
		String tcDataFile = "partner_174.properties";
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		String firstName2 = Utility.getData_TestCase(tcDataFile, "firstName2");
		String lastName2 = Utility.getData_TestCase(tcDataFile, "lastName2");
		String applicantFullName = firstName + " " + lastName;
		String applicantFullName2 = firstName2 + " " + lastName2;
		String age = Utility.getData_TestCase(tcDataFile, "age");
		String age2 = Utility.getData_TestCase(tcDataFile, "age2");
		...
		String s012Question2 = "What is " + applicantFullName2 + "'s " + Utility.getFromTextProperties("s012Question");
		...
		String s014Question2 = "Is " + applicantFullName2 + " " + Utility.getFromTextProperties("s014Question");
...
//		String s081Question2 = "Why did "+childFullName+"'s coverage end? (Optional)";
		...
		String minus90DaysDate2 = ESTTimeZone.getPreviousDate("90", "MM/d/yyyy");
		String firstDateOfNextMonth = ESTTimeZone.getStartOfNextMonth("MM/d/yyyy");
		...
		String s069DQuestion3 = "Which type of HRA coverage has "+applicantFullName+" been offered?";
		String s069DQuestion4 = "Is "+applicantFullName+" currently enrolled in an Qualified Small Employer HRA (QSEHRA) through this employer?";
...
//		commonMethodPage.ptc156S069DFillForm(applicantFullName, firstDateOfNextMonth, minus90DaysDate2);
		commonMethodPage.ptc156S069DFillForm(firstDateOfNextMonth, minus90DaysDate2);
...
//		commonMethodPage.downloadEligibilityReport();
		...
		// Contact Info
		ExtentTestManager.getTest().info("---------------------SCREEN S001----------------------------");
		applicantFullName = firstName2 + " " + lastName2;
		commonMethodPage.needCoverage(yes, "1");
		commonMethodPage.verifyS001(s001Question);
		commonMethodPage.enterFirstName(firstName2);
		dob = commonMethodPage.enterDob(age2);
		commonMethodPage.enterMiddleName("");
		commonMethodPage.enterLastName(lastName2);
		commonMethodPage.selectGender(male);
		commonMethodPage.clickSaveAndContinueButton();
		...
		*/
		...
		// Citizenship - 1st Appl - Citizenship
		ExtentTestManager.getTest().info("---------------------SCREEN S014----------------------------");
		commonMethodPage.verifyS014(s014Question2,s014DrawerHeading, s014drawerContent);
		commonMethodPage.chooseAnOption(yes, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
