...
//		commonMethodPage.chooseAnOption(no, 1, 3);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicad6);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.enterEducationExpenses(educationExpenses);
		...
		*/	
		...
		commonMethodPage.s089EnterDate(applicantFullName, minus60DaysDate);
		commonMethodPage.s089EnterDate(spouseFullName, minus60DaysDate);
		commonMethodPage.clickSaveAndContinueButton();
