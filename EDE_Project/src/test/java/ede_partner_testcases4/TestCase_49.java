...
public class TestCase_49 extends BaseTest {
	@Test
	public void testCase_49() throws Exception {

		ExtentTestManager.createTest("Test case 49", "Test case 49");
		...
		// Get data from testcase_49.properties
		String state = Utility.getDate_TestCase49("state");
		String firstName = Utility.getDate_TestCase49("firstName");
		String lastName = Utility.getDate_TestCase49("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase49("age");
		String streetAddress = Utility.getDate_TestCase49("streetAddress");
		String city = Utility.getDate_TestCase49("city");
		String OtherStreetAddress = Utility.getDate_TestCase49("OtherStreetAddress");
		String OtherCity = Utility.getDate_TestCase49("OtherCity");
		String zipCode = Utility.getDate_TestCase49("zipCode");
		String county = Utility.getDate_TestCase49("county");
		String phoneNumber = Utility.getDate_TestCase49("phoneNumber");
		String phoneType = Utility.getDate_TestCase49("phoneType");
		String SSN = Utility.getDate_TestCase49("SSN");
		String spouseSSN = Utility.getDate_TestCase49("spouseSSN");
		String relationShip = Utility.getDate_TestCase49("relationShip");
		String spouseFirstName = Utility.getDate_TestCase49("spouseFirstName");
		String incomeAmount = Utility.getDate_TestCase49("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase49("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_TestCase49("familypremiumAmount");
		String incomeType = Utility.getDate_TestCase49("incomeType");
		String employerName = Utility.getDate_TestCase49("employerName");
		String incomePeriod = Utility.getDate_TestCase49("incomePeriod");
		String spouseAge = Utility.getDate_TestCase49("spouseAge");
		String spouseLastName = Utility.getDate_TestCase49("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String applicantFullAddress = streetAddress + ", " + city + ", " + state + ", " + zipCode;
		String newphewFirstName = Utility.getDate_TestCase49("newphewFirstName");
		String newphewAge = Utility.getDate_TestCase49("newphewAge");
		String newphewLastName = Utility.getDate_TestCase49("newphewLastName");
		String newphewFullName = newphewFirstName + " " + newphewLastName;
		String s050OptionPregnant = Utility.getDate_TestCase49("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase49("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase49("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase49("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase49("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase49("spouseIncomePeriod");
		
		String anotherIncomeAmount = Utility.getDate_TestCase49("anotherIncomeAmount");
		String anotherIncomeType = Utility.getDate_TestCase49("anotherIncomeType");
		String anotherEmployerName = Utility.getDate_TestCase49("anotherEmployerName");
		String anotherIncomePeriod = Utility.getDate_TestCase49("anotherIncomePeriod");
		
		String secondChildIncomeAmount = Utility.getDate_TestCase49("secondChildIncomeAmount");
		String secondChildIncomeType = Utility.getDate_TestCase49("secondChildIncomeType");
		String secondChildEmployerName = Utility.getDate_TestCase49("secondChildEmployerName");
		String secondChildIncomePeriod = Utility.getDate_TestCase49("secondChildIncomePeriod");
		
		String EmployerPhone = Utility.getDate_TestCase49("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase49("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase49("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase49("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase49("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase49("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase49("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase49("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase49("childRelationShip");
		String plan = Utility.getDate_TestCase49("plan");
		String brotherRelation = Utility.getDate_TestCase49("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase49("otherRelationShip");
		String parentRelation = Utility.getDate_TestCase49("parentRelation");
		String parentRelationSecond = Utility.getDate_TestCase49("parentRelationSecond");
		String pragnent = Utility.getDate_TestCase49("pragnent");
		...
		commonMethodPage.applicantTakeCareOfChildrenFirst_S038(secondChildFullName);
		commonMethodPage.clickSaveAndContinueButton();
		Wait.wait5Second();
