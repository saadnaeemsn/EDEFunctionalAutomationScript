...
public class TestCase_114 extends BaseTest {
  @Test  public void testCase_114() throws Exception {

		ExtentTestManager.createTest("PTC114", "Partner Test Case 114");
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		// Get data from testcase_114.properties
		String tcDataFile = "partner_114.properties";
		...
		String s012SameNameQuestionChild1 = "Is " + childFullName + " " + Utility.getFromTextProperties("s012SameNameQuestion");
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		*/
		...
		if(state.trim().equalsIgnoreCase("az")) {
			...
			s049QuestionMedicad3 = "Did " + childFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");	
		}else if(state.trim().equalsIgnoreCase("tx")) {
			...
			s049QuestionMedicad3 = "Did " + childFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadTX");	
		}else if(state.trim().equalsIgnoreCase("fl")) {
...
//				commonMethodPage.verifyS038(s038Question2);
		...
		commonMethodPage.enterSSN(childSSN, s012SameNameQuestionChild1);
		commonMethodPage.chooseAnOption(yes, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.enterAnuualPreditedAmount(annualPredictedAmount);
		...
		*/
		...
		commonMethodPage.chooseAnOption(childFullName, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s081Question2, s081Question2, 2, 1);
		commonMethodPage.chooseAnOption(childCoverage, 2, 1);
		commonMethodPage.clickSaveAndContinueButton();
