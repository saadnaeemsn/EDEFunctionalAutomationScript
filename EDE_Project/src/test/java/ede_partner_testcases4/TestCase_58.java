...
public class TestCase_58  extends BaseTest {
	
	@Test
	public void testCase_58() throws Exception {


		ExtentTestManager.createTest("Test case 58", "Test case 58");
		...
		// Get data from data.properties
				...
				String state = Utility.getDate_TestCase58("state");
				String firstName = Utility.getDate_TestCase58("firstName");
				String lastName = Utility.getDate_TestCase58("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase58("age");
				String streetAddress = Utility.getDate_TestCase58("streetAddress");
				String city = Utility.getDate_TestCase58("city");
				String zipCode = Utility.getDate_TestCase58("zipCode");
				String county = Utility.getDate_TestCase58("county");
				String phoneNumber = Utility.getDate_TestCase58("phoneNumber");
				String phoneType = Utility.getDate_TestCase58("phoneType");
				String SSN = Utility.getDate_TestCase58("SSN");
				String spouseSSN = Utility.getDate_TestCase58("spouseSSN");
				String childSSN = Utility.getDate_TestCase58("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase58("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase58("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase58("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase58("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase58("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase58("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase58("incomeType");
				String employerName = Utility.getDate_TestCase58("employerName");
				String incomePeriod = Utility.getDate_TestCase58("incomePeriod");
				String anotherincomeAmount = Utility.getDate_TestCase58("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase58("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase58("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase58("anotherincomePeriod");
				String jobStartDate = Utility.getDate_TestCase58("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase58("jobEndDate");
				String aiAn = Utility.getDate_TestCase58("aiAn");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase58("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase58("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase58("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase58("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase58("relationShip");
				String spouseFirstName = Utility.getDate_TestCase58("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase58("spouseLastName");
				String spouseAge = Utility.getDate_TestCase58("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase58("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase58("gotMarried");
				String childFirstName = Utility.getDate_TestCase58("childFirstName");
				String childLastName = Utility.getDate_TestCase58("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase58("childAge");
				String childRelationShip = Utility.getDate_TestCase58("childRelationShip");
				String plan = Utility.getDate_TestCase58("plan");
				String withoutDocument = Utility.getDate_TestCase58("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase58("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase58("anualPredictedAmount");
				String hours = Utility.getDate_TestCase58("hours");
