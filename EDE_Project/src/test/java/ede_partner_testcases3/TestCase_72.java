...
public class TestCase_72 extends BaseTest{
	@Test
	public void testCase_72() throws Exception {
		...
		String state = Utility.getDate_TestCase_72("state");
		String firstName = Utility.getDate_TestCase_72("firstName");
		String lastName = Utility.getDate_TestCase_72("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_72("age");
		String streetAddress = Utility.getDate_TestCase_72("streetAddress");
		String city = Utility.getDate_TestCase_72("city");
		String zipCode = Utility.getDate_TestCase_72("zipCode");
		String county = Utility.getDate_TestCase_72("county");
		String phoneNumber = Utility.getDate_TestCase_72("phoneNumber");
		String phoneType = Utility.getDate_TestCase_72("phoneType");
		String SSN = Utility.getDate_TestCase_72("SSN");
		String spouseSSN = Utility.getDate_TestCase_72("spouseSSN");
		String childSSN = Utility.getDate_TestCase_72("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_72("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_72("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_72("domesticPartnerAge");
		String incomeAmount = Utility.getDate_TestCase_72("incomeAmount");
		String educatorExpense = Utility.getDate_TestCase_72("educatorExpense");
		String selfPremiumAmount = Utility.getDate_TestCase_72("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_72("incomeType");
		String incomeTypeChild = Utility.getDate_TestCase_72("incomeTypeChild");
		String employerName = Utility.getDate_TestCase_72("employerName");
		String incomePeriod = Utility.getDate_TestCase_72("incomePeriod");
		String incomePeriodChild = Utility.getDate_TestCase_72("incomePeriodChild");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_72("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_72("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_72("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_72("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_72("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_72("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_72("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_72("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_72("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_72("gotMarried");
		String childFirstName = Utility.getDate_TestCase_72("childFirstName");
		String childLastName = Utility.getDate_TestCase_72("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_72("childAge");
		String childRelationShip = Utility.getDate_TestCase_72("childRelationShip");
		String plan = Utility.getDate_TestCase_72("plan");
		String withoutDocument = Utility.getDate_TestCase_72("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_72("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_72("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_72("hours");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(grandChildRelation, grandChildRelation, "not applicable", "not applicable", "1");
		...
		commonMethodPage.selectIncomeType(incomeTypeChild);
		commonMethodPage.enterEmployerName(employerName);
		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3Child);
		commonMethodPage.incomePeriod_S057(incomePeriod);
		commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		commonMethodPage.enterIncomeAmount(incomeAmount);
		commonMethodPage.enterTribeIncomeAmount(educatorExpense);
		commonMethodPage.clickSaveAndContinueButton();
