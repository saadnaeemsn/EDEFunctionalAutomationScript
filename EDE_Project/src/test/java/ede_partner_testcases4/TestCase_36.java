...
public class TestCase_36 extends BaseTest {
	@Test
	public void TestCase_36() throws Exception {

		ExtentTestManager.createTest("Test case 36", "Test case 36");
		String tcDataFile = "partner_36.properties";
		...
		String s033Question = "Will "+fatherFullName+" claim any other tax dependents?";
...
//		commonMethodPage.needCoverage(no, "2");
		...
		*/
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation(nephewNieceRelationship, nephewNieceRelationship, "NA", "1");
		commonMethodPage.selectRelation(nephewNieceRelationship, cousinRelationship, "NA", "2");
		*/
		/*
		commonMethodPage.clickAddPerson();
		*/
...
//		commonMethodPage.verifyS027Dependent(s027Question3, s027DependentDrawerHeading,s027DependentDrawerContent);
//		commonMethodPage.verifyQuestionContents(spanTag, s027Question3, s027Question3, 1, 1);
		commonMethodPage.selectIsAnyDependent(no);
//		commonMethodPage.verifyQuestionContents(spanTag, s027Question2, s027QuestionAboutSingleDependents, 2, 1);
...
//		commonMethodPage.selectRelation(parentRelation, parentRelation, brotherRelationship, "4");
		...
		commonMethodPage.verifyQuestionContents(spanTag, s034Question, s034Question, 2, 1);
...
//		commonMethodPage.chooseAnOption(no, 1, 3);
		...
		commonMethodPage.enterDOB_S010(fatherAge, "1");
		commonMethodPage.enterFirstName(fatherFirstName);
		commonMethodPage.enterLastName(fatherLastName);
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation(parentRelationship, "No applicable", "not applicable", "1");
		commonMethodPage.clickSaveAndContinueButton();
		
		ExtentTestManager.getTest().info("---------------------SCREEN S032----------------------------");
		commonMethodPage.verifyQuestionContents(spanTag, s032Question, s032Question, 1, 1);
		commonMethodPage.chooseAnOption(married, 1, 1);
//		commonMethodPage.verifyQuestionContents(spanTag, s032Question2, s032Question2, 1, 1);
		commonMethodPage.chooseAnOption(yes, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s032Question3, s032Question3, 2, 1);
		commonMethodPage.chooseAnOption(someoneNotApplying, 2, 1);
		commonMethodPage.enterDOB_S010(spouseAge, "1");
		commonMethodPage.enterFirstName(spouseFirstName);
		commonMethodPage.enterLastName(spouseLastName);
//		commonMethodPage.selectGender(female);
		commonMethodPage.selectAnOption(selectTag, attrAriaLabel, "Sex", female, 1, 1);
		commonMethodPage.selectRelation(unrelatedRelationship, "No applicable", "not applicable", "1");
		commonMethodPage.selectRelation(stepparentRelationship, stepparentRelationship, "not applicable", "2");
		commonMethodPage.clickSaveAndContinueButton();
		
		ExtentTestManager.getTest().info("---------------------SCREEN S033----------------------------");
		commonMethodPage.verifyQuestionContents(spanTag, s033Question, s033Question, 2, 1);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyS002(s002Question);
		...
		*/
		...
		// 3rd Appl - SSN 
		ExtentTestManager.getTest().info("---------------------SCREEN S012----------------------------");
//		commonMethodPage.verifyS012(s012QuestionFather2);
//		commonMethodPage.verifyQuestionContents(divTag, s012QuestionFather, s012QuestionFather, 2, 1);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutSsnBtn();
		
		// 3rd Appl - Home Address
		ExtentTestManager.getTest().info("---------------------SCREEN S041----------------------------");
...
//		commonMethodPage.verifyQuestionContents(divTag, s012QuestionSpouse, s012QuestionSpouse, 2, 1);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutSsnBtn();
...
//				commonMethodPage.CoverageThroughJobStartingNextMonth_S070(noneOfThese);
		...
		*/
		...
		commonMethodPage.verifyQuestionContents(spanTag, s079Question, s079Question, 2, 1);
		commonMethodPage.chooseAnOption(secondChildFullName, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
		*/
