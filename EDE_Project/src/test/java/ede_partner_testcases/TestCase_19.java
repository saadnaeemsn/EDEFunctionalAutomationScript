...
public class TestCase_19 extends BaseTest {
	...
	public void testCase_19() throws Exception {
		...
		// This Test case needs to be completely updated to V8, it has alota changes
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation3G_S27(otherRelative, otherRelative, "not applicable", "not applicable", "2");
		commonMethodPage.clickSaveAndContinueButton();
