...
public class TestCase_80 extends BaseTest {
	@Test
	public void testCase_80() throws Exception {

		ExtentTestManager.createTest("PTC80", "Partner Test Case 80");
		...
		String fosterCareState = Utility.getDate_TestCase_80("fosterCareState");
		String firstName = Utility.getDate_TestCase_80("firstName");
		String lastName = Utility.getDate_TestCase_80("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_80("age");
		String streetAddress = Utility.getDate_TestCase_80("streetAddress");
		String city = Utility.getDate_TestCase_80("city");
		String zipCode = Utility.getDate_TestCase_80("zipCode");
		String county = Utility.getDate_TestCase_80("county");
		String phoneNumber = Utility.getDate_TestCase_80("phoneNumber");
		String phoneType = Utility.getDate_TestCase_80("phoneType");
		String SSN = Utility.getDate_TestCase_80("SSN");
		String spouseSSN = Utility.getDate_TestCase_80("spouseSSN");
		String childSSN = Utility.getDate_TestCase_80("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_80("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_80("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_80("domesticPartnerAge");
		String selfPremiumAmount = Utility.getDate_TestCase_80("selfOnlyPremiumAmount");
		String incomeAmount = Utility.getDate_TestCase_80("incomeAmount");
		String incomeType= Utility.getDate_TestCase_80("incomeType");
		String employerName = Utility.getDate_TestCase_80("employerName");
		String incomePeriod = Utility.getDate_TestCase_80("incomePeriod");
		String incomeAmount2 = Utility.getDate_TestCase_80("incomeAmount");
		String incomeType2 = Utility.getDate_TestCase_80("incomeType2");
		String employerName2 = Utility.getDate_TestCase_80("employerName2");
		String incomePeriod2 = Utility.getDate_TestCase_80("incomePeriod2");
		String incomeAmount3 = Utility.getDate_TestCase_80("incomeAmount3");
		String incomeType3 = Utility.getDate_TestCase_80("incomeType3");
		String employerName3 = Utility.getDate_TestCase_80("employerName3");
		String incomePeriod3 = Utility.getDate_TestCase_80("incomePeriod3");
		String incomeAmount4 = Utility.getDate_TestCase_80("incomeAmount4");
		String incomeType4 = Utility.getDate_TestCase_80("incomeType4");
		String employerName4 = Utility.getDate_TestCase_80("employerName4");
		String incomePeriod4 = Utility.getDate_TestCase_80("incomePeriod4");
		String incomeAmount5 = Utility.getDate_TestCase_80("incomeAmount5");
		String incomeType5 = Utility.getDate_TestCase_80("incomeType5");
		String employerName5 = Utility.getDate_TestCase_80("employerName5");
		String incomePeriod5 = Utility.getDate_TestCase_80("incomePeriod5");
		String incomeEndDate = Utility.getDate_TestCase_80("income5EndDate");
		String expensePeriod1 = Utility.getDate_TestCase_80("expensePeriod1");
		String expenseAmount1 = Utility.getDate_TestCase_80("expenseAmount1");
		String expensePeriod2 = Utility.getDate_TestCase_80("expensePeriod2");
		String expenseAmount2 = Utility.getDate_TestCase_80("expenseAmount2");

		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_80("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_80("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_80("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_80("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_80("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_80("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_80("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_80("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_80("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_80("gotMarried");
		String childFirstName = Utility.getDate_TestCase_80("childFirstName");
		String childLastName = Utility.getDate_TestCase_80("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_80("childAge");
		String childRelationShip = Utility.getDate_TestCase_80("childRelationShip");
		String plan = Utility.getDate_TestCase_80("plan");
		String withoutDocument = Utility.getDate_TestCase_80("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_80("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_80("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_80("hours");
		String leftFosterCareAge = Utility.getDate_TestCase_80("leftFosterCareAge");
		String document = Utility.getDate_TestCase_80("document");
		String documentType = Utility.getDate_TestCase_80("documentType");
...
//		String s012SameNameQuestionFemale = "Is " + applicantFullName + " " + Utility.getFromTextProperties("s012SameNameQuestionFemale");
		String s012SameNameQuestionFemale = "Is " + spouseFullName + " " + Utility.getFromTextProperties("s012SameNameQuestionFemale");
...
//		String s027QuestionSingle = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s027QuestionSingle") + " " + "2024" + "?";
		...
		// "2024" to be used for getting Current year
...
//		String s027QuestionDependentSingleFemale = "Will " + applicantFullName + " " + Utility.getFromTextProperties("s027QuestionDependentSingleFemale") + " " + "2024" + "?";
		String s027QuestionDependentSingleFemale = "Will " + applicantFullName + " and " + spouseFullName + " "
...
//				commonMethodPage.verifyS049(s046QuestionMedicad, s046QuestionCHIP);
		...
		commonMethodPage.expenseType_S058(studentLoanPayments);
		...
		commonMethodPage.expenseType_S058(alimonPayments);
