...
public class TestCase_162  extends BaseTest {
	...
	public void testCase_162() throws Exception {
		...
		// Get data from data.properties
				...
				String state = Utility.getDate_TestCase_162("state");
				String firstName = Utility.getDate_TestCase_162("firstName");
				String lastName = Utility.getDate_TestCase_162("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase_162("age");
				String streetAddress = Utility.getDate_TestCase_162("streetAddress");
				String city = Utility.getDate_TestCase_162("city");
				String zipCode = Utility.getDate_TestCase_162("zipCode");
				String county = Utility.getDate_TestCase_162("county");
				String phoneNumber = Utility.getDate_TestCase_162("phoneNumber");
				String phoneType = Utility.getDate_TestCase_162("phoneType");
				String SSN = Utility.getDate_TestCase_162("SSN");
				String spouseSSN = Utility.getDate_TestCase_162("spouseSSN");
				String childSSN = Utility.getDate_TestCase_162("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase_162("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase_162("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase_162("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase_162("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase_162("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase_162("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase_162("incomeType");
				String employerName = Utility.getDate_TestCase_162("employerName");
				String incomePeriod = Utility.getDate_TestCase_162("incomePeriod");
				String coverageType = Utility.getDate_TestCase_162("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase_162("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase_162("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase_162("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase_162("anotherincomePeriod");
				String jobStartDate = Utility.getDate_TestCase_162("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase_162("jobEndDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase_162("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase_162("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase_162("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase_162("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase_162("relationShip");
				String spouseFirstName = Utility.getDate_TestCase_162("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase_162("spouseLastName");
				String spouseAge = Utility.getDate_TestCase_162("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase_162("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase_162("gotMarried");
				String childFirstName = Utility.getDate_TestCase_162("childFirstName");
				String childLastName = Utility.getDate_TestCase_162("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase_162("childAge");
				String childRelationShip = Utility.getDate_TestCase_162("childRelationShip");
				String plan = Utility.getDate_TestCase_162("plan");
				String withoutDocument = Utility.getDate_TestCase_162("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase_162("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase_162("anualPredictedAmount");
				String hours = Utility.getDate_TestCase_162("hours");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				commonMethodPage.whichEmployerOfferHRA_S069C(anotherEmployerReason);
				commonMethodPage.enterEmployerName(employerName);
				commonMethodPage.whoWorksForEmployerHRA_S069C(noneOfThese);		
				commonMethodPage.clickSaveAndContinueButton();
				...
				commonMethodPage.individualNoticeDate_S069D(jobEndDate);
				Wait.wait2Second();
