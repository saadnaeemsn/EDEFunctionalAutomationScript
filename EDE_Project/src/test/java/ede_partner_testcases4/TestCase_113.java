...
public class TestCase_113 extends BaseTest {
  @Test  public void testCase_113() throws Exception {

		ExtentTestManager.createTest("PTC113", "Partner Test Case 113");
		String tcDataFile = "partner_113.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		if(state.trim().equalsIgnoreCase("or")) {
			s046QuestionMedicad = Utility.getFromTextProperties("s046QuestionMedicadOR") + " " + minus90DaysDate;
		...
		if(state.trim().equalsIgnoreCase("or")) {
			...
			s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
			s049QuestionMedicad3 = "Did " + firstChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
			s049QuestionMedicad4 = "Did " + secondChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
		} else if(state.trim().equalsIgnoreCase("ms")) {
			s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMS");
			s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMS");
			s049QuestionMedicad3 = "Did " + firstChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMS");
			s049QuestionMedicad4 = "Did " + secondChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMS");
		}
		...
		s082Question = null;
		if(state.trim().equalsIgnoreCase("or")) {
			s082Question = Utility.getFromTextProperties("s082QuestionOR");
		} else if(state.trim().equalsIgnoreCase("ms")) {
