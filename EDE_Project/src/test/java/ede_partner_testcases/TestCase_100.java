...
public class TestCase_100 extends BaseTest {
	@Test
	public void testCase_100() throws Exception {

		
		ExtentTestManager.createTest("PTC98", "Partner Test Case 98");
		
		String tcDataFile = "partner_100.properties";
...
//				String someoneElse = "Someone else who isn't applying for coverage";
				...
				String incomeAmount1 = Utility.getData_TestCase(tcDataFile, "incomeAmount1");
				...
				String nephewFirstName = Utility.getData_TestCase(tcDataFile,"nephewFirstName");
				String nephewAge = Utility.getData_TestCase(tcDataFile,"nephewAge");
				String nephewLastName = Utility.getData_TestCase(tcDataFile,"nephewLastName");
				...
				String s012QuestionNephew = "What is " + nephewFullName + "'s "
...
//		Wait.wait3Second();
		...
		*/
		...
		commonMethodPage.chooseAnOption(nephewFullName, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		
		...
		commonMethodPage.haveICHRAandQSEHRA_S069D(noneOfThesePeople);
...
//		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3);
		...
		commonMethodPage.selectPayment(incomePeriod);
		//commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		//commonMethodPage.enterIncomeAmount(incomeAmount);
		commonMethodPage.clickSaveAndContinueButton();
