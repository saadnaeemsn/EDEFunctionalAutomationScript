...
public class TestCase_175 extends BaseTest {
  @Test  public void testCase_175() throws Exception {

		ExtentTestManager.createTest("PTC175", "Partner Test Case 175");
		String tcDataFile = "partner_175.properties";
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		String phoneNumber2 = Utility.getData_TestCase(tcDataFile, "phoneNumber2");
...
//		commonMethodPage.downloadEligibilityReport();
		...
		// Phone and Email
		ExtentTestManager.getTest().info("---------------------SCREEN S004----------------------------");
		commonMethodPage.enterPhoneNumber(phoneNumber2);
		commonMethodPage.verifyS004(s004Question);
		commonMethodPage.selectPhoneType(phoneType);
		commonMethodPage.clickSaveAndContinueButton();
...
//				commonMethodPage.agreeOne();
		commonMethodPage.chooseAnOption("I agree to this statement", 1, 1);
		commonMethodPage.enterSignature(applicantFullName2);
//				Wait.wait2Second();
		commonMethodPage.clickSaveAndContinueButton();
//				Wait.wait5Second();
