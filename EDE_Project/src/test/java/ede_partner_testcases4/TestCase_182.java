...
public class TestCase_182  extends BaseTest {
	...
	public void testCase_182() throws Exception {
		...
		// Get data from data.properties
				...
				// Get data from testcase_182.properties
				...
				String firstCousinFirstName = Utility.getDate_TestCase182("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase182("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase182("firstCousinAge");
				...
				String SSN = Utility.getDate_TestCase182("SSN");
				String parentSSN = Utility.getDate_TestCase182("parentSSN");
				String childSSN = Utility.getDate_TestCase182("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase182("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase182("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase182("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase182("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase182("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase182("familypremiumAmount");
				...
				String coverageType = Utility.getDate_TestCase182("coverageType");
				String parentIncomeAmount = Utility.getDate_TestCase182("parentIncomeAmount");
				String parentIncomeType = Utility.getDate_TestCase182("parentIncomeType");
				String parentEmployerName = Utility.getDate_TestCase182("parentEmployerName");
				String parentIncomePeriod = Utility.getDate_TestCase182("parentIncomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase182("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase182("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase182("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase182("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase182("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase182("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase182("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase182("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase182("relationShip");
				String parentFirstName = Utility.getDate_TestCase182("parentFirstName");
				String parentLastName = Utility.getDate_TestCase182("parentLastName");
				String parentAge = Utility.getDate_TestCase182("parentAge");
				...
				String plan = Utility.getDate_TestCase182("plan");
				String withoutDocument = Utility.getDate_TestCase182("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase182("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase182("anualPredictedAmount");
				String hours = Utility.getDate_TestCase182("hours");
				...
				commonMethodPage.enterDOB_S010(parentAge,"2");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				commonMethodPage.selectDependent(parentFullName);
				commonMethodPage.clickSaveAndContinueButton();
				...
				commonMethodPage.enterSSN(parentSSN,s012SameNameQuestionSpouse);
				commonMethodPage.clickSaveAndContinueButton();
				commonMethodPage.selectWithSameName(yes);
				commonMethodPage.clickSaveAndContinueButton();
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				commonMethodPage.selectIncomeType(parentIncomeType);
				commonMethodPage.selectIncomeType(parentIncomeType);
				commonMethodPage.enterEmployerName(parentEmployerName);
				commonMethodPage.incomePeriod_S057(parentIncomePeriod);
				commonMethodPage.enterIncomeAmount(parentIncomeAmount);
				commonMethodPage.clickSaveAndContinueButton();
