...
public class TestCase_119 extends BaseTest {
  @Test  public void testCase_119() throws Exception {

		ExtentTestManager.createTest("PTC119", "Partner Test Case 119");
		String tcDataFile = "partner_119.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		if(state.trim().equalsIgnoreCase("or")) {
			...
			s046QuestionMedicad = Utility.getFromTextProperties("s046QuestionMedicad7") + " " + minus90DaysDate + "?";
		}
		String s046QuestionCHIP = Utility.getFromTextProperties("s046QuestionCHIP");
		String s046DrawerHeading = Utility.getFromTextProperties("s046DrawerHeading");
		String s046DrawerContent = Utility.getFromTextProperties("s046DrawerContent");
		String s049QuestionMedicad1 = null, s049QuestionMedicad2 = null;
		if(state.trim().equalsIgnoreCase("or")) {
			s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
			s049QuestionMedicad2 = "Did " + childFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");	
		} else if(state.trim().equalsIgnoreCase("wi")) {
			s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadWI");
			s049QuestionMedicad2 = "Did " + childFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadWI");
		}
...
//		String s081Question2 = "Why did "+childFullName+"'s coverage end? (Optional)";
		...
		if(state.trim().equalsIgnoreCase("or")) {
			...
			s082Question = Utility.getFromTextProperties("s082QuestionWI");
