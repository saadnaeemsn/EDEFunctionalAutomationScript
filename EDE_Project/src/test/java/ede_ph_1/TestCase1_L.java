...
public class TestCase1_L extends BaseTest {
	...
	public void testCase1_L() throws Exception {
		...
		String parentRelationship=Utility.getDate_TestCase1L("parentRelationship");
		...
		commonMethodPage.selectToAddNonAplicantSpouse_S026(someOneElse); // This line xpath is showing issue , Someone else isn't selcting
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(parentRelationship, parentRelationship, parentRelationship,  "not applicable",  "3");
		commonMethodPage.clickSaveAndContinueButton();
