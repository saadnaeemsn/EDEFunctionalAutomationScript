...
public class TestCase_162 extends BaseTest {
	...
	public void testCase_162() throws Exception {
		...
		ExtentTestManager.createTest("PTC162", "Partner Test Case 162");
...
//		Wait.wait5Second();
		// Questions's Contents Verification is remaining 
		commonMethodPage.haveICHRAandQSEHRA_PTC162S069D(applicantFullName);
		commonMethodPage.haveICHRAandQSEHRA_PTC162S069D(spouseFullName);
		...
		commonMethodPage.isCurrentlyEnrolledThroughEmployer_PTC162S069D(no);
		commonMethodPage.qsehraStartDate_S069D(qsehraStartDate);
		commonMethodPage.qsehraNoticeDate_S069D(qsehraNoticeDate);
		commonMethodPage.isCurrentlyEnrolledThroughEmployer2_PTC162S069D(no);
		commonMethodPage.clickSaveAndContinueButton();
