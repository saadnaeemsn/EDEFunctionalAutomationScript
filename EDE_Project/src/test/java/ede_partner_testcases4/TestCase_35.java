...
public class TestCase_35 extends BaseTest {
	@Test
	public void TestCase_35() throws Exception {

		ExtentTestManager.createTest("Test case 35", "Test case 35");
		String tcDataFile = "partner_35.properties";
...
//		commonMethodPage.verifyS027Dependent(s027Question3, s027DependentDrawerHeading,s027DependentDrawerContent);
		commonMethodPage.verifyQuestionContents(spanTag, s027QuestionDependentSingle, s027QuestionDependentSingle, 2, 1);
