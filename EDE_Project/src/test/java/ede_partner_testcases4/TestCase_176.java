...
public class TestCase_176 extends BaseTest {
  @Test  public void testCase_176() throws Exception {

		ExtentTestManager.createTest("PTC176", "Partner Test Case 176");
		String tcDataFile = "partner_176.properties";
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		String document = Utility.getData_TestCase(tcDataFile, "document");
		String documentType = Utility.getData_TestCase(tcDataFile, "documentType");
		String doc1 = Utility.getData_TestCase(tcDataFile, "doc1");
		String doc2 = Utility.getData_TestCase(tcDataFile, "doc2");
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s017QuestionDocs = "Does " + applicantFullName + " have one of these documents?";
		String s019Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s019Question");
//		String s019Question2 = "Select the document type that corresponds with " + applicantFullName + "'s " + Utility.getFromTextProperties("s019Question2");
		String s019Question2 = "Select the document type that corresponds with " + applicantFullName;
		String s021Question = "Does "+applicantFullName+" also have any of these document types or statuses?";
		...
		String s044Question = "Are any of these people an honorable discharged veteran or active duty member of the military?";
		String s046QuestionMedicad = null;
		if(state.trim().equalsIgnoreCase("mi")) {
			s046QuestionMedicad = Utility.getFromTextProperties("s046QuestionMedicadMI") + " " + minus90DaysDate + "?";	
			...
			s046QuestionMedicad = Utility.getFromTextProperties("s046QuestionMedicadDE") + " " + minus90DaysDate + "?";
		}
		String s046QuestionCHIP = Utility.getFromTextProperties("s046QuestionCHIP");
		String s046DrawerHeading = Utility.getFromTextProperties("s046DrawerHeading");
		String s046DrawerContent = Utility.getFromTextProperties("s046DrawerContent");
		String s049QuestionMedicad = null;
		if(state.trim().equalsIgnoreCase("mi")) {
			s049QuestionMedicad = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadMI");	
		}else if(state.trim().equalsIgnoreCase("de")) {
			s049QuestionMedicad = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadDE");
		}
		...
		String s050Question = null;
		if(state.trim().equalsIgnoreCase("de")) {
			s050Question = Utility.getFromTextProperties("s050QuestionMedicadDE");
		}
		String s050Question2 = "Has " + applicantFullName + " " + Utility.getFromTextProperties("s50Question3");
		String s050Question3 = "Has " + applicantFullName + " " + Utility.getFromTextProperties("s50Question4");
		...
		String s024Question2 = "Has " + applicantFullName;
...
//		commonMethodPage.clickContinueBtn();
		...
		*/
		...
		commonMethodPage.verifyQuestionContents(spanTag, s019Question, s019Question, 1, 1);
		commonMethodPage.chooseAnOption(yes, 2, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s019Question2, s019Question2, 2, 1);
		commonMethodPage.selectAnOption(selectTag, "aria-label", s019Question2, doc1, 2, 1);
		commonMethodPage.selectAnOption(selectTag, "aria-label", "Immigration document type", doc2, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutAddingMore();
		
		// Citizenship
		ExtentTestManager.getTest().info("---------------------SCREEN S021----------------------------");
		commonMethodPage.verifyQuestionContents(spanTag, s021Question, s021Question, 2, 1);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutAddingMore();
		
		// Citizenship
		ExtentTestManager.getTest().info("---------------------SCREEN S024----------------------------");
		commonMethodPage.verifyQuestionContents(spanTag, s024Question2, s024Question, 2, 1);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyPTC171S038(s038Question1);
		...
		commonMethodPage.verifyQuestionContents(spanTag, s044Question, s044Question, 2, 1);
		...
		commonMethodPage.verifyQuestionContents(spanTag, s049QuestionMedicad, s049QuestionMedicad, 1, 1);
		commonMethodPage.chooseAnOption(no, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.verifyQuestionContents(spanTag, s050Question, s050Question, 2, 1);
		commonMethodPage.chooseAnOption(applicantFullName, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s050Question2, s050Question2, 2, 1);
		commonMethodPage.chooseAnOption(no, 1, 1);
//		commonMethodPage.verifyQuestionContents(spanTag, s050Question3, s050Question3, 1, 1);
...
//				commonMethodPage.downloadEligibilityReport();
		...
		commonMethodPage.clickAnElement(buttonTag, yes, 1, 1);
...
//		commonMethodPage.selectNoticeMediumEmailAt(noticeMediumEmailAt);
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S010----------------------------");
		// Get application ID
		applicationId = commonMethodPage.getS010AppId();
		commonMethodPage.clickSaveAndContinueButton();
		...
		// Drived or naturalized
		ExtentTestManager.getTest().info("---------------------SCREEN S017----------------------------");
//		commonMethodPage.selectNaturalizedOrDrived(yes, "", "", "");
//		commonMethodPage.verifyQuestionContents(spanTag, s017QuestionDocs, s017QuestionDocs, 2, 1);
		commonMethodPage.chooseAnOption(yes, 1, 1);
		commonMethodPage.chooseAnOption(noneOfThese, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
