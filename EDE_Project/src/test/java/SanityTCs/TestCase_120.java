...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicad7");
		String s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicad7");
		String s049QuestionMedicad3 = "Did " + firstChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicad7");
		String s049QuestionMedicad4 = "Did " + secondChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicad7");
...
//				commonMethodPage.verifyS038(s038Question2);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicadTX);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyS082(s082Question, s083DrawerHeading, s83DrawerContent);
		commonMethodPage.verifyQuestionContents(spanTag, s082QuestionTX, s082QuestionTX, 1, 2);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
