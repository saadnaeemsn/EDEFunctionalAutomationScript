...
public class TestCase_120 extends BaseTest {
  @Test  public void testCase_120() throws Exception {

		ExtentTestManager.createTest("PTC120", "Partner Test Case 120");
		String tcDataFile = "partner_120.properties";
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		String relationship = Utility.getData_TestCase(tcDataFile, "relationship");
		String brotherRelation = Utility.getData_TestCase(tcDataFile, "brotherRelation");
		...
		String coverageEndReason = Utility.getData_TestCase(tcDataFile, "coverageEndReason");
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s046QuestionMedicadTX = Utility.getFromTextProperties("s046QuestionMedicadTX") + " " + minus90DaysDate;
		String s046QuestionCHIP = Utility.getFromTextProperties("s046QuestionCHIP");
		if(state.trim().equalsIgnoreCase("az")) {
			s046QuestionMedicad = Utility.getFromTextProperties("s046QuestionMedicadAZ") + " " + minus90DaysDate;	
		} else if(state.trim().equalsIgnoreCase("tx")) {
			s046QuestionMedicad = Utility.getFromTextProperties("s046QuestionMedicadTX") + " " + minus90DaysDate;
		}
		String s046DrawerHeading = Utility.getFromTextProperties("s046DrawerHeading");
		String s046DrawerContent = Utility.getFromTextProperties("s046DrawerContent");
		String s049QuestionMedicad1 = null, s049QuestionMedicad2 = null, s049QuestionMedicad3 = null, s049QuestionMedicad4 = null;
		if(state.trim().equalsIgnoreCase("az")) {
			s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
			s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
			s049QuestionMedicad3 = "Did " + firstChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
			s049QuestionMedicad4 = "Did " + secondChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");	
		} else if(state.trim().equalsIgnoreCase("tx")) {
			s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadTX");
			s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadTX");
			s049QuestionMedicad3 = "Did " + firstChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadTX");
			s049QuestionMedicad4 = "Did " + secondChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadTX");
		}		
		...
		String s082QuestionTX = Utility.getFromTextProperties("s082QuestionTX");
		s082Question = null;
		if(state.trim().equalsIgnoreCase("tx")) {
			s082Question = Utility.getFromTextProperties("s082QuestionTX");
		} else if(state.trim().equalsIgnoreCase("az")) {
			s082Question = Utility.getFromTextProperties("s082QuestionAZ");
		}
...
//						commonMethodPage.verifyS082(s082Question, s083DrawerHeading, s83DrawerContent);
		...
		commonMethodPage.chooseAnOption(firstChildFullName, 1, 1);
		commonMethodPage.chooseAnOption(secondChildFullName, 1, 1);
		commonMethodPage.chooseAnOption(coverageEndReason, 2, 1);
		commonMethodPage.chooseAnOption(coverageEndReason, 2, 2);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyQuestionContents(spanTag, s069DQuestion, s069DQuestion, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s069DQuestion2, s069DQuestion2, 2, 1);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
