...
public class TestCase_153 extends BaseTest {
  @Test  public void testCase_153() throws Exception {

		ExtentTestManager.createTest("PTC153", "Partner Test Case 153");
		String tcDataFile = "partner_153.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s046QuestionMedicadNC = Utility.getFromTextProperties("s046QuestionMedicadNC") + " " + minus90DaysDate;
...
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad1, 1);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicadNC);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.incomeVerification_S059(yes);
		commonMethodPage.addAnotherIncomeSource_S059B();

		// Income Questions - 1st Appl - Another Income source
		ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
//		Wait.wait2Second();
//		commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057Question);
//		commonMethodPage.chooseAnOption(yes, 1);
		...
		// Income verification - 1st Appl - Again
		ExtentTestManager.getTest().info("---------------------SCREEN S059----------------------------");
		// calculate monthly income
		Wait.wait2Second();
		commonMethodPage.incomeVerification_S059(yes);
		...
		*/
		...
		commonMethodPage.chooseAnOption(employerName2, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
