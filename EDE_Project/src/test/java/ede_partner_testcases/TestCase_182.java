...
public class TestCase_182 extends BaseTest {
	...
	public void testCase_182() throws Exception {
		...
		ExtentTestManager.createTest("CIC182", "CIC 182");
		...
		String s038Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s038Question1");
		String s038Question1 = "Is " + applicantFullName + " " + Utility.getFromTextProperties("s038Question2");
		String s038Question2 = "Is " + applicantFullName + " " + Utility.getFromTextProperties("s038Question1");
		String s038Question3 = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s038Question2");
...
//		commonMethodPage.enterDob(spouseAge);
		...
		Wait.wait2Second();
		commonMethodPage.verifyS038(s038Question3);
