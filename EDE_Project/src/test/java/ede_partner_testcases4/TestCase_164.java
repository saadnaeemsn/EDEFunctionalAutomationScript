...
public class TestCase_164  extends BaseTest {
	
	@Test
	public void testCase_164() throws Exception {


		ExtentTestManager.createTest("Test case 164", "Test case 164");
		...
		// Get data from data.properties
				...
				// Get data from testcase_164.properties
				String state = Utility.getDate_TestCase_164("state");
				String firstName = Utility.getDate_TestCase_164("firstName");
				String lastName = Utility.getDate_TestCase_164("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase_164("age");
				String firstCousinFirstName = Utility.getDate_TestCase_164("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase_164("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase_164("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase_164("streetAddress");
				String city = Utility.getDate_TestCase_164("city");
				String zipCode = Utility.getDate_TestCase_164("zipCode");
				String county = Utility.getDate_TestCase_164("county");
				String phoneNumber = Utility.getDate_TestCase_164("phoneNumber");
				String phoneType = Utility.getDate_TestCase_164("phoneType");
				String SSN = Utility.getDate_TestCase_164("SSN");
				String spouseSSN = Utility.getDate_TestCase_164("spouseSSN");
				String childSSN = Utility.getDate_TestCase_164("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase_164("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase_164("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase_164("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase_164("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase_164("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase_164("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase_164("incomeType");
				String employerName = Utility.getDate_TestCase_164("employerName");
				String incomePeriod = Utility.getDate_TestCase_164("incomePeriod");
				String coverageType = Utility.getDate_TestCase_164("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase_164("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase_164("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase_164("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase_164("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase_164("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase_164("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase_164("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase_164("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase_164("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase_164("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase_164("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase_164("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase_164("relationShip");
				String spouseFirstName = Utility.getDate_TestCase_164("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase_164("spouseLastName");
				String spouseAge = Utility.getDate_TestCase_164("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase_164("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase_164("gotMarried");
				String childFirstName = Utility.getDate_TestCase_164("childFirstName");
				String childLastName = Utility.getDate_TestCase_164("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase_164("childAge");
				String childRelationShip = Utility.getDate_TestCase_164("childRelationShip");
				String plan = Utility.getDate_TestCase_164("plan");
				String withoutDocument = Utility.getDate_TestCase_164("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase_164("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase_164("anualPredictedAmount");
				String hours = Utility.getDate_TestCase_164("hours");
				...
				commonMethodPage.enterDOB_S010(firstCousinAge,"2");
				commonMethodPage.enterFirstName(firstCousinFirstName);
				commonMethodPage.enterLastName(firstCousinLastName);
				commonMethodPage.selectGender(male);
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				commonMethodPage.selectDependent(firstCousinFirstName);
				commonMethodPage.clickSaveAndContinueButton();
			...
			//	commonMethodPage.verifyS026(s026QuestionFirstChild, s026DrawerHeading, s026DrawerContent);
				...
				// Income Questions for First Cousin
				ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
				...
				// Applicant Expense for First Cousin
				...
				// Income verification for First Cousin
				ExtentTestManager.getTest().info("---------------------SCREEN S059----------------------------");
				// calculate monthly income
				Wait.wait2Second();
				commonMethodPage.incomeVerification_S059(yes);
				...
				commonMethodPage.throughJobICHRAHaveNotAccept_S069B(firstCousinFullName);
				commonMethodPage.clickSaveAndContinueButton();
				...
				Wait.wait2Second();
				commonMethodPage.enterStartDateJobA(jobStartDate);
				commonMethodPage.enterEndDateJobA(jobEndDate);
				//commonMethodPage.enterIchraAmountOffered(selfPremiumAmount);
				//commonMethodPage.selectIchraAmountPeriod(premiumAmountPeriod);
				...
				commonMethodPage.selectCoverageTypeApplicant_S069D(coverageType);
				commonMethodPage.individualStartDate_S069D(jobStartDate);
				commonMethodPage.individualNoticeDate_S069D(jobNoticeDate);
				commonMethodPage.isCurrentlyEnrolledThroughEmployer_S069D2(no);
				commonMethodPage.clickSaveAndContinueButton();
