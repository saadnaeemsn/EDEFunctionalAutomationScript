...
public class TestCase_181 extends BaseTest {
	...
	public void testCase_181() throws Exception {
		...
		// Get data from testcase181.properties
		...
		String relationShip = Utility.getDate_TestCase181("relationShip");
		String domesticPartnerFirstName = Utility.getDate_TestCase181("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase181("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase181("domesticPartnerAge");
		...
		String SSN = Utility.getDate_TestCase181("SSN");
		String domesticPartnerSSN = Utility.getDate_TestCase181("domesticPartnerSSN");
		String firstChildSSN = Utility.getDate_TestCase181("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase181("secondChildSSN");
		...
		String spouseIncomeAmount = Utility.getDate_TestCase181("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase181("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase181("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase181("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase181("employerPhone");
		String gotMarried = Utility.getDate_TestCase181("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase181("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase181("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase181("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase181("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase181("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase181("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase181("childRelationShip");
		String spouseAge = Utility.getDate_TestCase181("spouseAge");
		String spouseIncomeAmountCIC = Utility.getDate_TestCase181("spouseIncomeAmountCIC");
		String brotherRelation = Utility.getDate_TestCase181("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase181("otherRelationShip");
		...
		String s012QuestionSpouse = "What is " + domesticPartnerFullName + "'s " + Utility.getFromTextProperties("s012Question");
		String s012SameNameQuestion = "Is " + applicantFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		String s012SameNameQuestionFemale = "Is " + domesticPartnerFullName + " "
		...
		String s014QuestionSpouse = "Is " + domesticPartnerFullName + " " + Utility.getFromTextProperties("s014Question");
		...
		String s027QuestionDependent = "Will " + applicantFullName + " and " + domesticPartnerFullName + " "
		...
		String s038QuestionSpouse = "Does " + domesticPartnerFullName + " " + Utility.getFromTextProperties("s038Question");
		...
		String s057QuestionSpouse = "Will " + domesticPartnerFullName + " " + Utility.getFromTextProperties("s057Question");
		String s057QuestionChild = "Will " + firstChildFullName + " " + Utility.getFromTextProperties("s057Question");
		String s057Question2Spouse = "Select a type of income " + domesticPartnerFullName + " "
				+ Utility.getFromTextProperties("s057Question2");
		String s057Question3Spouse = "How often does " + domesticPartnerFullName + " "
				+ Utility.getFromTextProperties("s057Question3");
		String s057Question4 = Utility.getFromTextProperties("s057Question4");
		String s058Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionSpouse = "Does " + domesticPartnerFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		...
		commonMethodPage.enterSSN(domesticPartnerSSN, s012SameNameQuestionFemale);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.selectWithSameName(yes);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation1_L(otherRelationShip, childRelationShip, "not applicable", "not applicable", "2");
		Wait.wait5Second();
		
		commonMethodPage.clickAddPersonTwo();
		...
		commonMethodPage.selectGender_S027(female);
		commonMethodPage.selectRelation3G_S27(otherRelationShip, childRelationShip, brotherRelation, "not applicable", "3");
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.liveWithTaxFilerParentWhoClaims_S031(yes);	
		commonMethodPage.clickSaveAndContinueButton();
...
//						ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
				...
				// Income Questions for Second Child
				ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
				//commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057QuestionSpouse);
				Wait.wait3Second();
				commonMethodPage.incomeThisMonth_S057(no);
