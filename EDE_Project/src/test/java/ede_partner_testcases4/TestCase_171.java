...
public class TestCase_171 extends BaseTest {
  @Test  public void testCase_171() throws Exception {

		ExtentTestManager.createTest("PTC171", "Partner Test Case 171");
		String tcDataFile = "partner_171.properties";
...
//		commonMethodPage.verifyQuestionContents(spanTag, s072BQuestion, s072BQuestion, 1, 1);
		commonMethodPage.chooseAnOption(noneOfThesePeople2, 1);
		commonMethodPage.clickSaveAndContinueButton();
