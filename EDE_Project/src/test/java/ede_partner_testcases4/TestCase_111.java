...
public class TestCase_111 extends BaseTest {
  @Test  public void testCase_111() throws Exception {

		ExtentTestManager.createTest("PTC111", "Partner Test Case 111");
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		// Get data from testcase_111.properties
		String tcDataFile = "partner_111.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s046QuestionMedicadOK = Utility.getFromTextProperties("s046QuestionMedicadOK") + " " + minus90DaysDate;
...
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad1, 1);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicadOK);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
