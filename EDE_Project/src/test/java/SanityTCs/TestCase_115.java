...
public class TestCase_115 extends BaseTest {
  @Test  public void testCase_115() throws Exception {

		ExtentTestManager.createTest("PTC115", "Partner Test Case 115");
		String tcDataFile = "partner_115.properties";
