...
public class TestCase_112 extends BaseTest {
  @Test  public void testCase_112() throws Exception {

		ExtentTestManager.createTest("PTC112", "Partner Test Case 112");
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		// Get data from testcase_112.properties
		String tcDataFile = "partner_112.properties";
...
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad1, 1);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicadIL);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
