...
public class TestCase_88 extends BaseTest {
	@Test
	public void testCase_88() throws Exception {


		ExtentTestManager.createTest("PTC88", "Partner Test Case 88");
		...
		// Get data from testcase_88.properties
		String state = Utility.getDate_TestCase_88("state");
		String firstName = Utility.getDate_TestCase_88("firstName");
		String lastName = Utility.getDate_TestCase_88("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_88("age");
		String streetAddress = Utility.getDate_TestCase_88("streetAddress");
		String city = Utility.getDate_TestCase_88("city");
		String zipCode = Utility.getDate_TestCase_88("zipCode");
		String county = Utility.getDate_TestCase_88("county");
		String phoneNumber = Utility.getDate_TestCase_88("phoneNumber");
		String phoneType = Utility.getDate_TestCase_88("phoneType");
		String SSN = Utility.getDate_TestCase_88("SSN");
		String spouseSSN = Utility.getDate_TestCase_88("spouseSSN");
		String childSSN = Utility.getDate_TestCase_88("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_88("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_88("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_88("domesticPartnerAge");
		String incomeAmount = Utility.getDate_TestCase_88("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase_88("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_88("incomeType");
		String employerName = Utility.getDate_TestCase_88("employerName");
		String incomePeriod = Utility.getDate_TestCase_88("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_88("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_88("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_88("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_88("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_88("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_88("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_88("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_88("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_88("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_88("gotMarried");
		String childFirstName = Utility.getDate_TestCase_88("childFirstName");
		String childLastName = Utility.getDate_TestCase_88("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_88("childAge");
		String childRelationShip = Utility.getDate_TestCase_88("childRelationShip");
		String plan = Utility.getDate_TestCase_88("plan");
		String withoutDocument = Utility.getDate_TestCase_88("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_88("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_88("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_88("hours");
...
//		String s038Question2 = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s038Question2");
		...
		String s027QuestionDependentSingleFemale = "Will " + applicantFullName + " "
				+ Utility.getFromTextProperties("s027QuestionDependentSingleFemale2") + " "
				+ "2024" + "?";
...
//		commonMethodPage.verifyS038(s038Question);
		...
		commonMethodPage.enterSSN(childSSN, s012SameNameQuestionFemale);
		commonMethodPage.selectWithSameName(yes);
		commonMethodPage.clickSaveAndContinueButton();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S28----------------------------");
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyS058(s058Question);
		...
		Wait.wait2Second();
		commonMethodPage.whatTypeCoverageHave_S069(CHIP);
		commonMethodPage.clickSaveAndContinueButton();
