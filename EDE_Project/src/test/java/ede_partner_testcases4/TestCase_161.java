...
public class TestCase_161  extends BaseTest {
	
	@Test
	public void testCase_161() throws Exception {


		ExtentTestManager.createTest("Test case 161", "Test case 161");
		...
		// Get data from data.properties
				...
				// Get data from testcase_161.properties
				String state = Utility.getDate_TestCase_161("state");
				String firstName = Utility.getDate_TestCase_161("firstName");
				String lastName = Utility.getDate_TestCase_161("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase_161("age");
				String streetAddress = Utility.getDate_TestCase_161("streetAddress");
				String city = Utility.getDate_TestCase_161("city");
				String zipCode = Utility.getDate_TestCase_161("zipCode");
				String county = Utility.getDate_TestCase_161("county");
				String phoneNumber = Utility.getDate_TestCase_161("phoneNumber");
				String phoneType = Utility.getDate_TestCase_161("phoneType");
				String SSN = Utility.getDate_TestCase_161("SSN");
				String spouseSSN = Utility.getDate_TestCase_161("spouseSSN");
				String childSSN = Utility.getDate_TestCase_161("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase_161("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase_161("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase_161("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase_161("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase_161("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase_161("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase_161("incomeType");
				String employerName = Utility.getDate_TestCase_161("employerName");
				String incomePeriod = Utility.getDate_TestCase_161("incomePeriod");
				String anotherincomeAmount = Utility.getDate_TestCase_161("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase_161("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase_161("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase_161("anotherincomePeriod");
				String jobStartDate = Utility.getDate_TestCase_161("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase_161("jobEndDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase_161("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase_161("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase_161("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase_161("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase_161("relationShip");
				String spouseFirstName = Utility.getDate_TestCase_161("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase_161("spouseLastName");
				String spouseAge = Utility.getDate_TestCase_161("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase_161("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase_161("gotMarried");
				String childFirstName = Utility.getDate_TestCase_161("childFirstName");
				String childLastName = Utility.getDate_TestCase_161("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase_161("childAge");
				String childRelationShip = Utility.getDate_TestCase_161("childRelationShip");
				String plan = Utility.getDate_TestCase_161("plan");
				String withoutDocument = Utility.getDate_TestCase_161("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase_161("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase_161("anualPredictedAmount");
				String hours = Utility.getDate_TestCase_161("hours");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				ExtentTestManager.getTest().info("---------------------SCREEN S057A----------------------------");
				...
				ExtentTestManager.getTest().info("---------------------SCREEN S069EE----------------------------");
				...
				//commonMethodPage.selectIchraAmountPeriod(incomePeriod);
