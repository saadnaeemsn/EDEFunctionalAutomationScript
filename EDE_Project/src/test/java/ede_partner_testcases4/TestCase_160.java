...
public class TestCase_160 extends BaseTest {
  @Test  public void testCase_160() throws Exception {

		ExtentTestManager.createTest("PTC160", "Partner Test Case 160");
		String tcDataFile = "partner_160.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s069DQuestion3 = "Is "+applicantFullName+" "+ Utility.getFromTextProperties("s069DQuestion9");;
		String s069DQuestion02 = Utility.getFromTextProperties("s069DQuestion4");
		String s069DQuestion03 = Utility.getFromTextProperties("s069DQuestion5");
