...
public class TestCase_28 extends BaseTest {
	@Test
	public void TestCase_28() throws Exception {

		ExtentTestManager.createTest("Test case 28", "Test case 28");
		String tcDataFile = "partner_28.properties";
...
//		commonMethodPage.verifyS002(s002Question);
		...
		if(state.trim().equalsIgnoreCase("ks")) {
			// S081
