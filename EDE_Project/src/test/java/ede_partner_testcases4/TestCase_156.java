...
public class TestCase_156 extends BaseTest {
  @Test  public void testCase_156() throws Exception {

		ExtentTestManager.createTest("PTC156", "Partner Test Case 156");
		String tcDataFile = "partner_156.properties";
...
//		commonMethodPage.selectRelation(relationShip, "No applicable", "not applicable", "1");
		...
		*/
		...
		Wait.wait2Second();
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 2);
		commonMethodPage.clickSaveAndContinueButton();
