...
public class TestCase_152 extends BaseTest {
  @Test  public void testCase_152() throws Exception {

		ExtentTestManager.createTest("PTC152", "Partner Test Case 152");
		String tcDataFile = "partner_152.properties";
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		String maxReimbursementAmount = Utility.getData_TestCase(tcDataFile, "maxReimbursementAmount");
...
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad1, 1);
		...
		commonMethodPage.chooseAnOption(isAIAN, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.ptc151S069EFillForm(plus60DaysDate2, plus65DaysDate2, maxReimbursementAmount, reimbursementPeriod, employerPhone, s069EQuestion1);
		commonMethodPage.clickSaveAndContinueButton();
