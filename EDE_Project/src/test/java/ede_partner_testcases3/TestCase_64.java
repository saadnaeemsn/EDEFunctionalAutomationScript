...
public class TestCase_64 extends BaseTest{

	@Test
	public void testCase_64() throws Exception {


		ExtentTestManager.createTest("Test case 64", "Test case 64");
		...
		String state = Utility.getDate_TestCase_64("state");
		String firstName = Utility.getDate_TestCase_64("firstName");
		String lastName = Utility.getDate_TestCase_64("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_64("age");
		String streetAddress = Utility.getDate_TestCase_64("streetAddress");
		String city = Utility.getDate_TestCase_64("city");
		String zipCode = Utility.getDate_TestCase_64("zipCode");
		String county = Utility.getDate_TestCase_64("county");
		String phoneNumber = Utility.getDate_TestCase_64("phoneNumber");
		String phoneType = Utility.getDate_TestCase_64("phoneType");
		String SSN = Utility.getDate_TestCase_64("SSN");
		String spouseSSN = Utility.getDate_TestCase_64("spouseSSN");
		String childSSN = Utility.getDate_TestCase_64("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_64("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_64("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_64("domesticPartnerAge");
		String incomeAmount = Utility.getDate_TestCase_64("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase_64("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_64("incomeType");
		String employerName = Utility.getDate_TestCase_64("employerName");
		String incomePeriod = Utility.getDate_TestCase_64("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_64("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_64("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_64("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_64("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_64("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_64("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_64("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_64("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_64("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_64("gotMarried");
		String childFirstName = Utility.getDate_TestCase_64("childFirstName");
		String childLastName = Utility.getDate_TestCase_64("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_64("childAge");
		String childRelationShip = Utility.getDate_TestCase_64("childRelationShip");
		String plan = Utility.getDate_TestCase_64("plan");
		String withoutDocument = Utility.getDate_TestCase_64("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_64("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_64("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_64("hours");
