...
public class TestCase_82 extends BaseTest {

	@Test
	public void testCase_82() throws Exception {

		ExtentTestManager.createTest("PTC82", "Partner Test Case 82");
		...
		// Get data from testcase_82.properties
		String state = Utility.getDate_TestCase_82("state");
		String fosterCareState = Utility.getDate_TestCase_82("fosterCareState");
		String firstName = Utility.getDate_TestCase_82("firstName");
		String lastName = Utility.getDate_TestCase_82("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_82("age");
		String streetAddress = Utility.getDate_TestCase_82("streetAddress");
		String city = Utility.getDate_TestCase_82("city");
		String zipCode = Utility.getDate_TestCase_82("zipCode");
		String county = Utility.getDate_TestCase_82("county");
		String phoneNumber = Utility.getDate_TestCase_82("phoneNumber");
		String phoneType = Utility.getDate_TestCase_82("phoneType");
		String SSN = Utility.getDate_TestCase_82("SSN");
		String spouseSSN = Utility.getDate_TestCase_82("spouseSSN");
		String childSSN = Utility.getDate_TestCase_82("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_82("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_82("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_82("domesticPartnerAge");
		String selfPremiumAmount = Utility.getDate_TestCase_82("selfOnlyPremiumAmount");
		String incomeAmount = Utility.getDate_TestCase_82("incomeAmount");
		String incomeType = Utility.getDate_TestCase_82("incomeType");
		String employerName = Utility.getDate_TestCase_82("employerName");
		String incomePeriod = Utility.getDate_TestCase_82("incomePeriod");

		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_82("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_82("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_82("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_82("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_82("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_82("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_82("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_82("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_82("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_82("gotMarried");
		String childFirstName = Utility.getDate_TestCase_82("childFirstName");
		String childLastName = Utility.getDate_TestCase_82("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_82("childAge");
		String childRelationShip = Utility.getDate_TestCase_82("childRelationShip");
		String plan = Utility.getDate_TestCase_82("plan");
		String withoutDocument = Utility.getDate_TestCase_82("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_82("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_82("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_82("hours");
		String leftFosterCareAge = Utility.getDate_TestCase_82("leftFosterCareAge");
		String document = Utility.getDate_TestCase_82("document");
		String documentType = Utility.getDate_TestCase_82("documentType");
...
//		String s027QuestionMale = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s027QuestionMale") + " " + "2024" + "?";
		...
		String s049QuestionMedicad = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicad2");
		...
		String s027QuestionDependentSingleFemale = "Will " + applicantFullName + " "
				+ Utility.getFromTextProperties("s027QuestionDependentSingleFemale") + " " + "2024" + "?";
//		String s027QuestionDependentSingle = "Will " + applicantFullName + " " + Utility.getFromTextProperties("s027QuestionSomeOneElseTaxReturn") + " " + "2024" + "?";
		String s027QuestionDependentSingle = "Will " + applicantFullName + " " + Utility.getFromTextProperties("s027QuestionDependentSingle") + " " + "2024" + "?";
...
//		commonMethodPage.verifyS049(s046QuestionMedicad, s046QuestionCHIP);
		commonMethodPage.verifyPTC085S049(s049QuestionMedicad, s046QuestionCHIP);
