...
public class TestCase_180 extends BaseTest {
	@Test
	public void testCase_180() throws Exception {
		...
		String SSN = Utility.getDate_TestCase180("SSN");
		String spouseSSN = Utility.getDate_TestCase180("spouseSSN");
		String relationShip = Utility.getDate_TestCase180("relationShip");
		String spouseFirstName = Utility.getDate_TestCase180("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase180("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase180("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase180("babyCount");
		...
		String spouseIncomeAmount = Utility.getDate_TestCase180("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase180("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase180("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase180("spouseIncomePeriod");
		String firstChildIncomeAmount = Utility.getDate_TestCase180("firstChildIncomeAmount");
		String firstChildIncomeType = Utility.getDate_TestCase180("firstChildIncomeType");
		String firstChildEmployerName = Utility.getDate_TestCase180("firstChildEmployerName");
		String firstChildIncomePeriod = Utility.getDate_TestCase180("firstChildIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase180("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase180("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase180("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase180("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase180("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase180("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase180("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase180("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase180("childRelationShip");
		String remove = Utility.getDate_TestCase180("remove") + " " + spouseFullName + " "
				+ Utility.getDate_TestCase180("fromApplication");
		String brotherRelation = Utility.getDate_TestCase180("brotherRelation");
		String divorce = Utility.getDate_TestCase180("divorce");
		String divorceDate = ESTTimeZone.getCurrentDate("MM/dd/yyyy");
		String incomeAmountCIC = Utility.getDate_TestCase180("incomeAmountCIC");
		...
		commonMethodPage.enterDob(age, 2);
