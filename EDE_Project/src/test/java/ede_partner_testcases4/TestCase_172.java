...
public class TestCase_172 extends BaseTest {
  @Test  public void testCase_172() throws Exception {

		ExtentTestManager.createTest("PTC172", "Partner Test Case 172");
		String tcDataFile = "partner_172.properties";
...
//		String someoneElse = "Someone else who isn't applying for coverage";
		...
		String s012QuestionChild = "What is " + childFullName + "'s " + Utility.getFromTextProperties("s012Question2");
...
//		commonMethodPage.clickContinueBtn();
		...
		*/
		...
		commonMethodPage.enterSSN(applSSN, s012SameNameQuestionMale);
