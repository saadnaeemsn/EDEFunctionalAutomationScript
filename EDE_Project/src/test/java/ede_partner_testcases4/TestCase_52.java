...
public class TestCase_52 extends BaseTest {
	@Test
	public void testCase_52() throws Exception {

		ExtentTestManager.createTest("Test case 52", "Test case 52");
		...
		// Get data from testcase_52.properties
		String state = Utility.getDate_TestCase52("state");
		String firstName = Utility.getDate_TestCase52("firstName");
		String lastName = Utility.getDate_TestCase52("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase52("age");
		String streetAddress = Utility.getDate_TestCase52("streetAddress");
		String city = Utility.getDate_TestCase52("city");
		String OtherStreetAddress = Utility.getDate_TestCase52("OtherStreetAddress");
		String OtherCity = Utility.getDate_TestCase52("OtherCity");
		String zipCode = Utility.getDate_TestCase52("zipCode");
		String county = Utility.getDate_TestCase52("county");
		String phoneNumber = Utility.getDate_TestCase52("phoneNumber");
		String phoneType = Utility.getDate_TestCase52("phoneType");
		String SSN = Utility.getDate_TestCase52("SSN");
		String spouseSSN = Utility.getDate_TestCase52("spouseSSN");
		String relationShip = Utility.getDate_TestCase52("relationShip");
		String spouseFirstName = Utility.getDate_TestCase52("spouseFirstName");
		String incomeAmount = Utility.getDate_TestCase52("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase52("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_TestCase52("familypremiumAmount");
		String incomeType = Utility.getDate_TestCase52("incomeType");
		String employerName = Utility.getDate_TestCase52("employerName");
		String incomePeriod = Utility.getDate_TestCase52("incomePeriod");
		String spouseAge = Utility.getDate_TestCase52("spouseAge");
		String spouseLastName = Utility.getDate_TestCase52("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String applicantFullAddress = streetAddress + ", " + city + ", " + state + ", " + zipCode;
		String newphewFirstName = Utility.getDate_TestCase52("newphewFirstName");
		String newphewAge = Utility.getDate_TestCase52("newphewAge");
		String newphewLastName = Utility.getDate_TestCase52("newphewLastName");
		String newphewFullName = newphewFirstName + " " + newphewLastName;
		String s050OptionPregnant = Utility.getDate_TestCase52("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase52("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase52("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase52("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase52("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase52("spouseIncomePeriod");
		
		String firstChildIncomeAmount = Utility.getDate_TestCase52("firstChildIncomeAmount");
		String firstChildIncomeType = Utility.getDate_TestCase52("firstChildIncomeType");
		String firstChildEmployerName = Utility.getDate_TestCase52("firstChildEmployerName");
		String firstChildIncomePeriod = Utility.getDate_TestCase52("firstChildIncomePeriod");
		
		String secondChildIncomeAmount = Utility.getDate_TestCase52("secondChildIncomeAmount");
		String secondChildIncomeType = Utility.getDate_TestCase52("secondChildIncomeType");
		String secondChildEmployerName = Utility.getDate_TestCase52("secondChildEmployerName");
		String secondChildIncomePeriod = Utility.getDate_TestCase52("secondChildIncomePeriod");
		
		String EmployerPhone = Utility.getDate_TestCase52("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase52("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase52("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase52("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase52("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase52("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase52("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase52("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase52("childRelationShip");
		String plan = Utility.getDate_TestCase52("plan");
		String brotherRelation = Utility.getDate_TestCase52("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase52("otherRelationShip");
		String parentRelation = Utility.getDate_TestCase52("parentRelation");
		String parentRelationSecond = Utility.getDate_TestCase52("parentRelationSecond");
		String pragnent = Utility.getDate_TestCase52("pragnent");
		...
		Wait.wait3Second();
		commonMethodPage.selectDependent(newphewFullName);
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S027----------------------------");
		Wait.wait3Second();
		commonMethodPage.whoIsTaxFilerWhoClaims_S028(applicantFullName);
		commonMethodPage.clickSaveAndContinueButton();
		...
		//commonMethodPage.verifyS050A(s050AQuestion);
		Wait.wait2Second();
		commonMethodPage.whoIsPregnant_S053(newphewFullName);
		commonMethodPage.whoIsPregnant_S053(firstChildFullName);
		commonMethodPage.selectBabyCount(babyCount);
		commonMethodPage.selectBabyCountP2(babyCount);
		commonMethodPage.clickSaveAndContinueButton();
