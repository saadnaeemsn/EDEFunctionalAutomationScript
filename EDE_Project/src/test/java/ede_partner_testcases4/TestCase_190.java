...
public class TestCase_190 extends BaseTest {
	@Test
	public void testCase_190() throws Exception {

		ExtentTestManager.createTest("Test case 190", "Test case 190");
		...
		// Get data from testcase190.properties
		String state = Utility.getDate_TestCase190("state");
		String firstName = Utility.getDate_TestCase190("firstName");
		String lastName = Utility.getDate_TestCase190("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase190("age");
		String streetAddress = Utility.getDate_TestCase190("streetAddress");
		String city = Utility.getDate_TestCase190("city");
		String zipCode = Utility.getDate_TestCase190("zipCode");
		String county = Utility.getDate_TestCase190("county");
		String applicantFullAddress = streetAddress + ", " + city + ", " + state + ", " + zipCode;
		String phoneNumber = Utility.getDate_TestCase190("phoneNumber");
		String phoneType = Utility.getDate_TestCase190("phoneType");
		String relationShip = Utility.getDate_TestCase190("relationShip");
		String newphewFirstName = Utility.getDate_TestCase190("newphewFirstName");
		String newphewLastName = Utility.getDate_TestCase190("newphewLastName");
		String newphewFullName = newphewFirstName + " " + newphewLastName;
		String newphewAge = Utility.getDate_TestCase190("newphewAge");
		String lastDate = Utility.getDate_TestCase190("lastDate");
		String s050OptionPregnant = Utility.getDate_TestCase190("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase190("babyCount");
		String incomeAmount = Utility.getDate_TestCase190("incomeAmount");
		String SSN = Utility.getDate_TestCase190("SSN");
		String newphewSSN = Utility.getDate_TestCase190("newphewSSN");
		String firstChildSSN = Utility.getDate_TestCase190("firstChildSSN");
		String secondChildSSN = Utility.getDate_TestCase190("secondChildSSN");
		String incomeType = Utility.getDate_TestCase190("incomeType");
		String employerName = Utility.getDate_TestCase190("employerName");
		String incomePeriod = Utility.getDate_TestCase190("incomePeriod");
		String newphewIncomeAmount = Utility.getDate_TestCase190("newphewIncomeAmount");
		String newphewIncomeType = Utility.getDate_TestCase190("newphewIncomeType");
		String newphewEmployerName = Utility.getDate_TestCase190("newphewEmployerName");
		String newphewIncomePeriod = Utility.getDate_TestCase190("newphewIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase190("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase190("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase190("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase190("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase190("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase190("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase190("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase190("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase190("childRelationShip");
		String spouseAge = Utility.getDate_TestCase190("spouseAge");
		String spouseIncomeAmountCIC = Utility.getDate_TestCase190("spouseIncomeAmountCIC");
		String brotherRelation = Utility.getDate_TestCase190("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase190("otherRelationShip");
		...
		String s012QuestionSpouse = "What is " + newphewFullName + "'s " + Utility.getFromTextProperties("s012Question");
		String s012SameNameQuestion = "Is " + applicantFullName + " "
				+ Utility.getFromTextProperties("s012SameNameQuestion");
		String s012SameNameQuestionFemale = "Is " + newphewFullName + " "
		...
		String s014QuestionSpouse = "Is " + newphewFullName + " " + Utility.getFromTextProperties("s014Question");
		...
		String s027QuestionDependent = "Will " + applicantFullName + " and " + newphewFullName + " "
		...
		String s038QuestionSpouse = "Does " + newphewFullName + " " + Utility.getFromTextProperties("s038Question");
		...
		String s057QuestionSpouse = "Will " + newphewFullName + " " + Utility.getFromTextProperties("s057Question");
		String s057QuestionChild = "Will " + firstChildFullName + " " + Utility.getFromTextProperties("s057Question");
		String s057Question2Spouse = "Select a type of income " + newphewFullName + " "
				+ Utility.getFromTextProperties("s057Question2");
		String s057Question3Spouse = "How often does " + newphewFullName + " "
				+ Utility.getFromTextProperties("s057Question3");
		String s057Question4 = Utility.getFromTextProperties("s057Question4");
		String s058Question = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		String s058QuestionSpouse = "Does " + newphewFullName + " " + Utility.getFromTextProperties("s058Question") + " "
				+ ESTTimeZone.getCurrentYear() + "?";
		...
		String s074QuestionSpouse = Utility.getFromTextProperties("s074Question") + " " + newphewEmployerName + " ("
				+ newphewFullName + "'s job).";
		...
		String s090Question2 = "When did " + applicantFullName + " and " + newphewFullName + " "
				+ Utility.getFromTextProperties("s090Question2");
		String s090Question3 = "Did " + applicantFullName + " or " + newphewFullName + " "
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation1_L(relationShip, childRelationShip, "not applicable", "not applicable", "2");
		...
		// SSN for Domestic Partner
		ExtentTestManager.getTest().info("---------------------SCREEN S012----------------------------");
		//commonMethodPage.verifyS012(s012QuestionSpouse);
		Wait.wait3Second();
		commonMethodPage.enterSSN(newphewSSN, s012SameNameQuestionFemale);
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.selectWithSameName(yes);
		commonMethodPage.clickSaveAndContinueButton();
		...
		Wait.wait5Second();
		commonMethodPage.foundNotEligibleMedicaidOrCHIP_S046(newphewFullName);
		commonMethodPage.s046EnterDate(lastDate);
		commonMethodPage.clickSaveAndContinueButton();
		
		ExtentTestManager.getTest().info("---------------------SCREEN S047----------------------------");
		//commonMethodPage.verifyS046(s046QuestionMedicad, s046QuestionCHIP, s046DrawerHeading, s046DrawerContent);
		Wait.wait3Second();
		commonMethodPage.applyForHealthCoverage_S047(newphewFullName);
		commonMethodPage.clickSaveAndContinueButton();
...
//		ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		// Income Questions for Domestic
		ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
		//commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057QuestionSpouse);
		Wait.wait3Second();
		commonMethodPage.incomeThisMonth_S057(yes);
		//commonMethodPage.verifyS057Question2IncomeType(s057Question2);
		commonMethodPage.selectIncomeType(newphewIncomeType);
		commonMethodPage.enterEmployerName(newphewEmployerName);
		//commonMethodPage.verifyS057Question3IncomeDuration(s057Question3);
		commonMethodPage.incomePeriod_S057(newphewIncomePeriod);
		//commonMethodPage.verifyS057Question4EnterIncome(s057Question4);
		commonMethodPage.enterIncomeAmount(newphewIncomeAmount);
		commonMethodPage.clickSaveAndContinueButton();
...
//				ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		commonMethodPage.clickSaveAndContinueButton();
				...
				// Income Questions for First Child
				ExtentTestManager.getTest().info("---------------------SCREEN S057----------------------------");
				//commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057Question);
				Wait.wait3Second();
