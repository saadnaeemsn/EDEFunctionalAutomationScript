...
public class TestCase_184 extends BaseTest {
	...
	public void testCase_184() throws Exception {
		...
		String OtherStreetAddress = Utility.getDate_TestCase184("OtherStreetAddress");
		String OtherCity = Utility.getDate_TestCase184("OtherCity");
		...
		String selfPremiumAmount = Utility.getDate_TestCase184("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_TestCase184("familypremiumAmount");
		...
		String spouseAge = Utility.getDate_TestCase184("spouseAge");
		String spouseLastName = Utility.getDate_TestCase184("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String newphewFirstName = Utility.getDate_TestCase184("newphewFirstName");
		String newphewAge = Utility.getDate_TestCase184("newphewAge");
		String newphewLastName = Utility.getDate_TestCase184("newphewLastName");
		...
		String secondChildIncomeAmount = Utility.getDate_TestCase184("secondChildIncomeAmount");
		String secondChildIncomeType = Utility.getDate_TestCase184("secondChildIncomeType");
		String secondChildEmployerName = Utility.getDate_TestCase184("secondChildEmployerName");
		String secondChildIncomePeriod = Utility.getDate_TestCase184("secondChildIncomePeriod");
		...
		String plan = Utility.getDate_TestCase184("plan");
		String brotherRelation = Utility.getDate_TestCase184("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase184("otherRelationShip");
		String parentRelation = Utility.getDate_TestCase184("parentRelation");
		String parentRelationSecond = Utility.getDate_TestCase184("parentRelationSecond");
		...
		commonMethodPage.selectGender(male);
		Wait.wait3Second();
		commonMethodPage.selectRelation1_L(parentRelationSecond, otherRelationShip, otherRelationShip, "not applicable", "3");
		commonMethodPage.clickSaveAndContinueButton();
