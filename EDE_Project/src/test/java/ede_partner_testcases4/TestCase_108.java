...
public class TestCase_108 extends BaseTest {
  @Test  public void testCase_108() throws Exception {

		ExtentTestManager.createTest("PTC108", "Partner Test Case 108");
...
//		String single = Utility.getValue("single");
		...
		// Get data from testcase_108.properties
		String tcDataFile = "partner_108.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		} else if(state.trim().equalsIgnoreCase("wi")) {
...
//		commonMethodPage.selectRelation(childRelationship, "No applicable", "not applicable", "2");
		...
		*/
		...
		if(commonMethodPage.verifyS015(s015Question)) {
			// Citizenship - 1st Appl
			ExtentTestManager.getTest().info("---------------------SCREEN S015----------------------------");
			commonMethodPage.verifyS015(s015Question);
			commonMethodPage.chooseAnOption(yes, 1, 1);
			commonMethodPage.clickSaveAndContinueButton();
			
			// Citizenship - 1st Appl - Optional
			ExtentTestManager.getTest().info("---------------------SCREEN S016----------------------------");
			commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyPTC171S038(s038Question2);
		...
		// SSN - 2nd Appl - Spouse
		ExtentTestManager.getTest().info("---------------------SCREEN S012 - 2nd Appl------------------");
		...
		// Sexual Orientation - 2nd Appl - Spouse
		ExtentTestManager.getTest().info("---------------------SCREEN S042A----------------------------");
		commonMethodPage.clickSaveAndContinueButton();
		
		// Race - 2nd Appl - Spouse
		ExtentTestManager.getTest().info("---------------------SCREEN S043----------------------------");
		commonMethodPage.clickSaveAndContinueButton();

		// SSN - 3rd Appl - Spouse
		ExtentTestManager.getTest().info("---------------------SCREEN S012 - 3rd Appl------------------");
...
//		commonMethodPage.clickWithOutSSN();
		...
		*/
		...
		// More About Household Questions
...
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad11, 1);
//		commonMethodPage.haveMedicaidOrChipEndedOrEndedSoon_S049_P1(no);
		commonMethodPage.chooseAnOption(no, 1, 1);
//		commonMethodPage.verifyQuestionContents(s049QuestionMedicad12, 2);
//		commonMethodPage.haveMedicaidOrChipEndedOrEndedSoon_S049_P2(no);
		commonMethodPage.chooseAnOption(no, 1, 2);
//		commonMethodPage.verifyPTC085S049(s049QuestionMedicad12, s046QuestionCHIP);
//		commonMethodPage.chooseAnOption(no, 1, 3);
		...
		commonMethodPage.selectSitutionHouseHold_S050A(noneOfTheseApply);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.enterEducationExpenses(educationExpenses);
		...
		*/	
		...
		commonMethodPage.s089EnterDate(spouseFullName, minus60DaysDate2);
		commonMethodPage.s089EnterDate(applicantFullName, minus60DaysDate2);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.chooseAnOption(applicantFullName + " & " + spouseFullName, 1, 1);
		commonMethodPage.s090EnterDate(minus60DaysDate);
		commonMethodPage.selectAnswer4PTC105S090Last2Questions();
		commonMethodPage.clickSaveAndContinueButton();
		*/
