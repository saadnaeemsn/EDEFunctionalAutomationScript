...
public class TestCase_59  extends BaseTest {
	
	@Test
	public void testCase_59() throws Exception {


		ExtentTestManager.createTest("Test case 59", "Test case 59");
		...
		// Get data from data.properties
				...
				// Get data from testcase_59.properties
				String state = Utility.getDate_TestCase59("state");
				String firstName = Utility.getDate_TestCase59("firstName");
				String lastName = Utility.getDate_TestCase59("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase59("age");
				String firstCousinFirstName = Utility.getDate_TestCase59("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase59("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase59("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase59("streetAddress");
				String city = Utility.getDate_TestCase59("city");
				String zipCode = Utility.getDate_TestCase59("zipCode");
				String county = Utility.getDate_TestCase59("county");
				String phoneNumber = Utility.getDate_TestCase59("phoneNumber");
				String phoneType = Utility.getDate_TestCase59("phoneType");
				String SSN = Utility.getDate_TestCase59("SSN");
				String spouseSSN = Utility.getDate_TestCase59("spouseSSN");
				String childSSN = Utility.getDate_TestCase59("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase59("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase59("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase59("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase59("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase59("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase59("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase59("incomeType");
				String employerName = Utility.getDate_TestCase59("employerName");
				String incomePeriod = Utility.getDate_TestCase59("incomePeriod");
				String coverageType = Utility.getDate_TestCase59("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase59("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase59("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase59("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase59("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase59("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase59("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase59("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase59("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase59("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase59("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase59("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase59("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase59("relationShip");
				String tribeState = Utility.getDate_TestCase59("tribeState");
				String tribe = Utility.getDate_TestCase59("tribe");
				String spouseFirstName = Utility.getDate_TestCase59("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase59("spouseLastName");
				String spouseAge = Utility.getDate_TestCase59("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase59("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase59("gotMarried");
				String childFirstName = Utility.getDate_TestCase59("childFirstName");
				String childLastName = Utility.getDate_TestCase59("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase59("childAge");
				String aiAn = Utility.getDate_TestCase59("aiAn");
				String childRelationShip = Utility.getDate_TestCase59("childRelationShip");
				String plan = Utility.getDate_TestCase59("plan");
				String withoutDocument = Utility.getDate_TestCase59("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase59("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase59("anualPredictedAmount");
				String hours = Utility.getDate_TestCase59("hours");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				commonMethodPage.enterOtherIncomeSourceS069(employerName);
				...
				commonMethodPage.selectState_S075(tribeState);
