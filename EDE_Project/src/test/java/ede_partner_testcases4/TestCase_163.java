...
public class TestCase_163  extends BaseTest {
	
	@Test
	public void testCase_163() throws Exception {


		ExtentTestManager.createTest("Test case 163", "Test case 163");
		...
		// Get data from data.properties
				...
				// Get data from testcase_162.properties
				String state = Utility.getDate_TestCase_163("state");
				String firstName = Utility.getDate_TestCase_163("firstName");
				String lastName = Utility.getDate_TestCase_163("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase_163("age");
				String streetAddress = Utility.getDate_TestCase_163("streetAddress");
				String city = Utility.getDate_TestCase_163("city");
				String zipCode = Utility.getDate_TestCase_163("zipCode");
				String county = Utility.getDate_TestCase_163("county");
				String phoneNumber = Utility.getDate_TestCase_163("phoneNumber");
				String phoneType = Utility.getDate_TestCase_163("phoneType");
				String SSN = Utility.getDate_TestCase_163("SSN");
				String spouseSSN = Utility.getDate_TestCase_163("spouseSSN");
				String childSSN = Utility.getDate_TestCase_163("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase_163("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase_163("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase_163("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase_163("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase_163("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase_163("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase_163("incomeType");
				String employerName = Utility.getDate_TestCase_163("employerName");
				String incomePeriod = Utility.getDate_TestCase_163("incomePeriod");
				String coverageType = Utility.getDate_TestCase_163("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase_163("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase_163("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase_163("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase_163("anotherincomePeriod");
				String jobStartDate = Utility.getDate_TestCase_163("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase_163("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase_163("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase_163("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase_163("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase_163("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase_163("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase_163("relationShip");
				String spouseFirstName = Utility.getDate_TestCase_163("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase_163("spouseLastName");
				String spouseAge = Utility.getDate_TestCase_163("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase_163("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase_163("gotMarried");
				String childFirstName = Utility.getDate_TestCase_163("childFirstName");
				String childLastName = Utility.getDate_TestCase_163("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase_163("childAge");
				String childRelationShip = Utility.getDate_TestCase_163("childRelationShip");
				String plan = Utility.getDate_TestCase_163("plan");
				String withoutDocument = Utility.getDate_TestCase_163("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase_163("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase_163("anualPredictedAmount");
				String hours = Utility.getDate_TestCase_163("hours");
