...
public class TestCase_26 extends BaseTest {
	...
	public void TestCase_26() throws Exception {
		...
		ExtentTestManager.createTest("Test case 26", "Test case 26");
		String tcDataFile = "partner_26.properties";
...
//		commonMethodPage.selectRelation(brotherRelationship, brotherRelationship, "not applicable", "2");
