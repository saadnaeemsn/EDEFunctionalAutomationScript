...
public class TestCase_180 extends BaseTest {
	...
	public void TestCase_180() throws Exception {
		...
		String tcDataFile = "partner_180.properties";
		...
		String s038QuestionFirstChild = "Does " + firstChildFullName + " " + Utility.getFromTextProperties("s038Question2");
		...
		String s046Question = null, s049Question = null;
...
//		commonMethodPage.refreshPage();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S038----------------------------");
//				 commonMethodPage.verifyS038(s038Question);
		commonMethodPage.verifyQuestionContents(spanTag, s038QuestionFirstChild, s038QuestionFirstChild, 1, 1);
...
//		commonMethodPage.chooseAnOption(no, 1, 3);
		...
		commonMethodPage.verifyQuestionContents(spanTag, s010BQuestionFemale, s010BQuestionFemale, 1, 1);
		commonMethodPage.chooseAnOption(removeAppl, 1, 1);
		commonMethodPage.chooseAnOption(divorce, 1, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s010BQuestion2, s010BQuestion2, 1, 1);
		commonMethodPage.chooseAnOption(divorce, 1, 1);
		commonMethodPage.enterNSelectOption(inputTag, attrAriaLabel, dateOfDivorce, 1, todayDate2, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s010BQuestionFirstChild, s010BQuestionFirstChild, 1, 1);
		commonMethodPage.chooseAnOption(changeFirstChildStatus, 2, 1);
		commonMethodPage.verifyQuestionContents(spanTag, s010BQuestionSecondChild, s010BQuestionSecondChild, 1, 1);
		commonMethodPage.chooseAnOption(changeSecondChildStatus, 2, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		Wait.wait2Second();
//		commonMethodPage.refreshPage();
		commonMethodPage.verifyS012(s012QuestionFirstChild2);
		commonMethodPage.enterSSN(firstChildSSN, s012SameNameQuestionFirstChild);
		commonMethodPage.chooseAnOption(yes, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyS049(s046QuestionMedicad, s046QuestionCHIP);
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S046----------------------------");
//		commonMethodPage.verifyS046(s046QuestionMedicad, s046QuestionCHIP, s046DrawerHeading, s046DrawerContent);
		commonMethodPage.verifyQuestionContents(spanTag, s046Question, s046Question, 1, 1);
		commonMethodPage.foundNotEligibleMedicaidOrCHIP_S046(noneOfThese);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057QuestionFirstChild);
		commonMethodPage.incomeThisMonth_S057(yes);
		commonMethodPage.verifyS057Question2IncomeType(s057QuestionFirstChild2);
		commonMethodPage.selectIncomeType(firstChildIncomeType);
		commonMethodPage.enterEmployerName(firstChildEmployerName);
		commonMethodPage.verifyS057Question3IncomeDuration(s057QuestionFirstChild3);
...
//						Wait.wait3Second();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S062----------------------------");
		commonMethodPage.clickSaveAndContinueButton();
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S069D----------------------------");
//		commonMethodPage.verifyS069D(s069DQuestion);
		commonMethodPage.throughJobICHRA_S069A(noneOfThese);
		commonMethodPage.clickSaveAndContinueButton();
