...
public class TestCase_62 extends BaseTest{
	@Test
	public void testCase_62() throws Exception {


		ExtentTestManager.createTest("Test case 62", "Test case 62");
		...
		String firstName = Utility.getDate_TestCase_62("firstName");
		String lastName = Utility.getDate_TestCase_62("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_62("age");
		String streetAddress = Utility.getDate_TestCase_62("streetAddress");
		String city = Utility.getDate_TestCase_62("city");
		String zipCode = Utility.getDate_TestCase_62("zipCode");
		String county = Utility.getDate_TestCase_62("county");
		String phoneNumber = Utility.getDate_TestCase_62("phoneNumber");
		String phoneType = Utility.getDate_TestCase_62("phoneType");
		String SSN = Utility.getDate_TestCase_62("SSN");
		String spouseSSN = Utility.getDate_TestCase_62("spouseSSN");
		String childSSN = Utility.getDate_TestCase_62("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_62("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_62("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_62("domesticPartnerAge");
		String incomeAmount = Utility.getDate_TestCase_62("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase_62("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_62("incomeType");
		String employerName = Utility.getDate_TestCase_62("employerName");
		String incomePeriod = Utility.getDate_TestCase_62("incomePeriod");
		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_62("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_62("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_62("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_62("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_62("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_62("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_62("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_62("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_62("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_62("gotMarried");
		String childFirstName = Utility.getDate_TestCase_62("childFirstName");
		String childLastName = Utility.getDate_TestCase_62("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_62("childAge");
		String childRelationShip = Utility.getDate_TestCase_62("childRelationShip");
		String plan = Utility.getDate_TestCase_62("plan");
		String withoutDocument = Utility.getDate_TestCase_62("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_62("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_62("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_62("hours");
