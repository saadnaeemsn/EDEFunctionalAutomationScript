...
public class TestCase_107 extends BaseTest {
  @Test  public void testCase_107() throws Exception {

		ExtentTestManager.createTest("PTC107", "Partner Test Case 107");
...
//		String single = Utility.getValue("single");
		...
		// Get data from testcase_107.properties
		String tcDataFile = "partner_107.properties";
		...
		String s046QuestionMedicad6 = Utility.getFromTextProperties("s046QuestionMedicad6");
...
//		commonMethodPage.verifyPTC085S049(s046QuestionMedicad1, s046QuestionCHIP);
