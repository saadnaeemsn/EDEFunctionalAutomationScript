...
public class TestCase_106 extends BaseTest {
  @Test
  public void testCase_106() throws Exception {

		ExtentTestManager.createTest("PTC106", "Partner Test Case 106");
...
//		String single = Utility.getValue("single");
		...
		// Get data from testcase_106.properties
		String tcDataFile = "partner_106.properties";
...
//		commonMethodPage.selectIsAnyDependentMarriedButFillingSeprate_027(no);
		...
		*/
		...
		commonMethodPage.verifyS046(s046QuestionMedicad6, s046QuestionCHIP, s046DrawerHeading, s046DrawerContent);
		...
		*/
		...
		commonMethodPage.chooseAnOption(gotMarried, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.s090EnterDate(minus60DaysDate2);
