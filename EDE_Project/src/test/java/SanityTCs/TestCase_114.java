...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
		String s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
		String s049QuestionMedicad3 = "Did " + childFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadAZ");
...
//				commonMethodPage.verifyS038(s038Question2);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicadAZ);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.verifyS082(s082Question, s083DrawerHeading, s83DrawerContent);
		commonMethodPage.verifyQuestionContents(spanTag, s082QuestionAZ, s082QuestionAZ, 1, 2);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
