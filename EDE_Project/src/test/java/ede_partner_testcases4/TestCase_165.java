...
public class TestCase_165  extends BaseTest {
	
	@Test
	public void testCase_165() throws Exception {


		ExtentTestManager.createTest("Test case 165", "Test case 165");
		...
		// Get data from data.properties
				...
				// Get data from testcase_165.properties
				String state = Utility.getDate_TestCase_165("state");
				String firstName = Utility.getDate_TestCase_165("firstName");
				String lastName = Utility.getDate_TestCase_165("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase_165("age");
				String firstCousinFirstName = Utility.getDate_TestCase_165("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase_165("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase_165("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase_165("streetAddress");
				String city = Utility.getDate_TestCase_165("city");
				String zipCode = Utility.getDate_TestCase_165("zipCode");
				String county = Utility.getDate_TestCase_165("county");
				String phoneNumber = Utility.getDate_TestCase_165("phoneNumber");
				String phoneType = Utility.getDate_TestCase_165("phoneType");
				String SSN = Utility.getDate_TestCase_165("SSN");
				String spouseSSN = Utility.getDate_TestCase_165("spouseSSN");
				String childSSN = Utility.getDate_TestCase_165("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase_165("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase_165("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase_165("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase_165("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase_165("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase_165("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase_165("incomeType");
				String employerName = Utility.getDate_TestCase_165("employerName");
				String incomePeriod = Utility.getDate_TestCase_165("incomePeriod");
				String coverageType = Utility.getDate_TestCase_165("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase_165("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase_165("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase_165("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase_165("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase_165("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase_165("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase_165("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase_165("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase_165("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase_165("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase_165("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase_165("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase_165("relationShip");
				String spouseFirstName = Utility.getDate_TestCase_165("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase_165("spouseLastName");
				String spouseAge = Utility.getDate_TestCase_165("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase_165("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase_165("gotMarried");
				String childFirstName = Utility.getDate_TestCase_165("childFirstName");
				String childLastName = Utility.getDate_TestCase_165("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase_165("childAge");
				String childRelationShip = Utility.getDate_TestCase_165("childRelationShip");
				String plan = Utility.getDate_TestCase_165("plan");
				String withoutDocument = Utility.getDate_TestCase_165("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase_165("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase_165("anualPredictedAmount");
				String hours = Utility.getDate_TestCase_165("hours");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				//commonMethodPage.selectDependent(no);
				commonMethodPage.clickSaveAndContinueButton();
				...
				// Income verification for Spouse
				ExtentTestManager.getTest().info("---------------------SCREEN S059----------------------------");
				// calculate monthly income
				Wait.wait2Second();
				commonMethodPage.incomeVerification_S059(yes);
