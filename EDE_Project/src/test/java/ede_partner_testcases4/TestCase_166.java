...
public class TestCase_166  extends BaseTest {
	
	@Test
	public void testCase_166() throws Exception {


		ExtentTestManager.createTest("Test case 166", "Test case 166");
		...
		// Get data from data.properties
				...
				// Get data from testcase_166.properties
				String state = Utility.getDate_TestCase_166("state");
				String firstName = Utility.getDate_TestCase_166("firstName");
				String lastName = Utility.getDate_TestCase_166("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase_166("age");
				String firstCousinFirstName = Utility.getDate_TestCase_166("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase_166("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase_166("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase_166("streetAddress");
				String city = Utility.getDate_TestCase_166("city");
				String zipCode = Utility.getDate_TestCase_166("zipCode");
				String county = Utility.getDate_TestCase_166("county");
				String phoneNumber = Utility.getDate_TestCase_166("phoneNumber");
				String phoneType = Utility.getDate_TestCase_166("phoneType");
				String SSN = Utility.getDate_TestCase_166("SSN");
				String spouseSSN = Utility.getDate_TestCase_166("spouseSSN");
				String childSSN = Utility.getDate_TestCase_166("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase_166("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase_166("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase_166("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase_166("incomeAmount");
				...
				String coverageType = Utility.getDate_TestCase_166("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase_166("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase_166("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase_166("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase_166("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase_166("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase_166("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase_166("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase_166("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase_166("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase_166("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase_166("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase_166("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase_166("relationShip");
				String spouseFirstName = Utility.getDate_TestCase_166("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase_166("spouseLastName");
				String spouseAge = Utility.getDate_TestCase_166("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase_166("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase_166("gotMarried");
				String childFirstName = Utility.getDate_TestCase_166("childFirstName");
				String childLastName = Utility.getDate_TestCase_166("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase_166("childAge");
				String childRelationShip = Utility.getDate_TestCase_166("childRelationShip");
				String plan = Utility.getDate_TestCase_166("plan");
				String withoutDocument = Utility.getDate_TestCase_166("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase_166("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase_166("anualPredictedAmount");
				String hours = Utility.getDate_TestCase_166("hours");
