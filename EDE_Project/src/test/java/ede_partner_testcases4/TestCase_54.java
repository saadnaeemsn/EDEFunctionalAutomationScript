...
public class TestCase_54  extends BaseTest {
	
	@Test
	public void testCase_54() throws Exception {


		ExtentTestManager.createTest("Test case 54", "Test case 54");
		...
		// Get data from data.properties
				...
				// Get data from testcase_54.properties
				String state = Utility.getDate_TestCase54("state");
				String firstName = Utility.getDate_TestCase54("firstName");
				String lastName = Utility.getDate_TestCase54("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase54("age");
				String firstCousinFirstName = Utility.getDate_TestCase54("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase54("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase54("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase54("streetAddress");
				String city = Utility.getDate_TestCase54("city");
				String zipCode = Utility.getDate_TestCase54("zipCode");
				String county = Utility.getDate_TestCase54("county");
				String phoneNumber = Utility.getDate_TestCase54("phoneNumber");
				String phoneType = Utility.getDate_TestCase54("phoneType");
				String SSN = Utility.getDate_TestCase54("SSN");
				String spouseSSN = Utility.getDate_TestCase54("spouseSSN");
				String childSSN = Utility.getDate_TestCase54("childSSN");
				String domesticPartnerFirstName = Utility.getDate_TestCase54("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase54("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase54("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase54("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase54("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase54("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase54("incomeType");
				String employerName = Utility.getDate_TestCase54("employerName");
				String incomePeriod = Utility.getDate_TestCase54("incomePeriod");
				String coverageType = Utility.getDate_TestCase54("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase54("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase54("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase54("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase54("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase54("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase54("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase54("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase54("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase54("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase54("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase54("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase54("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase54("relationShip");
				String tribeState = Utility.getDate_TestCase54("tribeState");
				String tribe = Utility.getDate_TestCase54("tribe");
				String spouseFirstName = Utility.getDate_TestCase54("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase54("spouseLastName");
				String spouseAge = Utility.getDate_TestCase54("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase54("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase54("gotMarried");
				String childFirstName = Utility.getDate_TestCase54("childFirstName");
				String childLastName = Utility.getDate_TestCase54("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase54("childAge");
				String aiAn = Utility.getDate_TestCase54("aiAn");
				String childRelationShip = Utility.getDate_TestCase54("childRelationShip");
				String plan = Utility.getDate_TestCase54("plan");
				String withoutDocument = Utility.getDate_TestCase54("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase54("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase54("anualPredictedAmount");
				String hours = Utility.getDate_TestCase54("hours");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				Wait.wait2Second();
				commonMethodPage.selectSitutionHouseHold_S050A(aiAn);
				commonMethodPage.clickSaveAndContinueButton();
				...
				//commonMethodPage.verifyS050A(s050AQuestion);
				Wait.wait2Second();
				commonMethodPage.whoIsIncarcerated_S094(applicantFullName);
				commonMethodPage.whoIsIncarcerated_S094(spouseFullName);
				commonMethodPage.incarceratedPendingDisposition_S094_P1(yes);
				commonMethodPage.incarceratedPendingDisposition_S094_P2(no);
				commonMethodPage.clickSaveAndContinueButton();
