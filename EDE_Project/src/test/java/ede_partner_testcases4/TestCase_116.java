...
public class TestCase_116 extends BaseTest {
  @Test  public void testCase_116() throws Exception {

		ExtentTestManager.createTest("PTC116", "Partner Test Case 116");
		String tcDataFile = "partner_116.properties";
...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s049QuestionMedicad2 = "Did " + childFullName + " " + Utility.getFromTextProperties("s049QuestionMedicad5");
...
//		commonMethodPage.verifyPTC107S046(s046QuestionMedicad7);
		commonMethodPage.verifyQuestionContents(spanTag, s046QuestionMedicadOH, s046QuestionMedicadOH, 1, 1);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.chooseAnOption("I agree to allow the Marketplace to end the Marketplace coverage for anyone on my application who’s enrolled in both Marketplace and Medicare coverage.", 1);
