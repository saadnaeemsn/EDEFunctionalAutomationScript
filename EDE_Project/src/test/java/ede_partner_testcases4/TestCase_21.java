...
public class TestCase_21 extends BaseTest {
	...
	public void testCase_21() throws Exception {
		...
		// Get data from testcase_21.properties
		...
		String SSN = Utility.getDate_TestCase21("SSN");
		String spouseSSN = Utility.getDate_TestCase21("spouseSSN");
		String relationShip = Utility.getDate_TestCase21("relationShip");
		String spouseFirstName = Utility.getDate_TestCase21("spouseFirstName");
		String spouseAge = Utility.getDate_TestCase21("spouseAge");
		String spouseLastName = Utility.getDate_TestCase21("spouseLastName");
		...
		String s050OptionPregnant = Utility.getDate_TestCase21("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase21("babyCount");
		String inc = Utility.getDate_TestCase21("inc");
		String fooster = Utility.getDate_TestCase21("fooster");
		String pragnent = Utility.getDate_TestCase21("pragnent");
		String incomeAmount = Utility.getDate_TestCase21("incomeAmount");
		String incomeType = Utility.getDate_TestCase21("incomeType");
		String employerName = Utility.getDate_TestCase21("employerName");
		String incomePeriod = Utility.getDate_TestCase21("incomePeriod");
		String EmployerPhone = Utility.getDate_TestCase21("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase21("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase21("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase21("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase21("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase21("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase21("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase21("secondChildAge");
		String thirdChildFirstName = Utility.getDate_TestCase21("thirdChildFirstName");
		String thirdChildLastName = Utility.getDate_TestCase21("thirdChildLastName");
		String thirdChildFullName = thirdChildFirstName + " " + thirdChildLastName;
		String thirdChildAge = Utility.getDate_TestCase21("thirdChildAge");
		String childRelationShip = Utility.getDate_TestCase21("childRelationShip");
		String stepChildRelationShip = Utility.getDate_TestCase21("stepChildRelationShip");
		String plan = Utility.getDate_TestCase21("plan");
		String fAge = Utility.getDate_TestCase21("fAge");
		String otherCoverage = Utility.getDate_TestCase21("otherCoverage");
		String brotherRelation = Utility.getDate_TestCase21("brotherRelation");
		String parentRelation = Utility.getDate_TestCase21("parentRelation");
		String parent2Relation = Utility.getDate_TestCase21("parent2Relation");
		String grandParentRelation = Utility.getDate_TestCase21("grandParentRelation");
		
		//String someOneElse = Utility.getDate_TestCase21("someOneElse");
		...
		commonMethodPage.enterDOB_S010(nephewAge,"2");
		...
		commonMethodPage.selectRelation3G_S28(grandParentRelation, "not applicable", "not applicable", "not applicable", "1");
		Wait.wait2Second();
		commonMethodPage.canYouProvideMoreInfo_S028(yes);
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(parentRelation, "not applicable", "not applicable", "not applicable", "1");
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.selectGender_S038(male);
		commonMethodPage.selectRelation1_L(parentRelation, grandParentRelation, "not applicable", "not applicable", "2");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(parent2Relation, brotherRelation, childRelationShip, childRelationShip, "4");
		commonMethodPage.clickSaveAndContinueButton();
		...
		//commonMethodPage.verifyS041A(s041AQuestion, s041ADrawerHeading, s041ADrawerContent);
		Wait.wait3Second();
		commonMethodPage.whatIsHomeAddress_S041(fullAddress);
		commonMethodPage.clickSaveAndContinueButton();
...
//								ExtentTestManager.getTest().info("Verified: " + yearlyIncomeFound);
		...
		Wait.wait3Second();
		commonMethodPage.isParentLiveOutSideHome_S079(nephewFullName);
		commonMethodPage.clickSaveAndContinueButton();
