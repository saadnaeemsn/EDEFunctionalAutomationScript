...
public class TestCase_81 extends BaseTest {
	@Test
	public void testCase_81() throws Exception {

		ExtentTestManager.createTest("PTC81", "Partner Test Case 81");
		...
		// Get data from testcase_81.properties
		String state = Utility.getDate_TestCase_81("state");
		String fosterCareState = Utility.getDate_TestCase_81("fosterCareState");
		String firstName = Utility.getDate_TestCase_81("firstName");
		String lastName = Utility.getDate_TestCase_81("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_81("age");
		String streetAddress = Utility.getDate_TestCase_81("streetAddress");
		String city = Utility.getDate_TestCase_81("city");
		String zipCode = Utility.getDate_TestCase_81("zipCode");
		String county = Utility.getDate_TestCase_81("county");
		String phoneNumber = Utility.getDate_TestCase_81("phoneNumber");
		String phoneType = Utility.getDate_TestCase_81("phoneType");
		String SSN = Utility.getDate_TestCase_81("SSN");
		String spouseSSN = Utility.getDate_TestCase_81("spouseSSN");
		String childSSN = Utility.getDate_TestCase_81("childSSN");
		String domesticPartnerFirstName = Utility.getDate_TestCase_81("domesticPartnerFirstName");
		String domesticPartnerLastName = Utility.getDate_TestCase_81("domesticPartnerLastName");
		String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
		String domesticPartnerAge = Utility.getDate_TestCase_81("domesticPartnerAge");
		String selfPremiumAmount = Utility.getDate_TestCase_81("selfOnlyPremiumAmount");
		String incomeAmount = Utility.getDate_TestCase_81("incomeAmount");
		String incomeType = Utility.getDate_TestCase_81("incomeType");
		String employerName = Utility.getDate_TestCase_81("employerName");
		String incomePeriod = Utility.getDate_TestCase_81("incomePeriod");

		String domesticPartnerIncomeAmount = Utility.getDate_TestCase_81("domesticPartnerIncomeAmount");
		String domesticPartnerIncomeType = Utility.getDate_TestCase_81("domesticPartnerIncomeType");
		String domesticPartnerEmployerName = Utility.getDate_TestCase_81("domesticPartnerEmployerName");
		String domesticPartnerIncomePeriod = Utility.getDate_TestCase_81("domesticPartnerIncomePeriod");
		String relationShip = Utility.getDate_TestCase_81("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_81("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_81("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_81("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_81("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_81("gotMarried");
		String childFirstName = Utility.getDate_TestCase_81("childFirstName");
		String childLastName = Utility.getDate_TestCase_81("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_81("childAge");
		String childRelationShip = Utility.getDate_TestCase_81("childRelationShip");
		String plan = Utility.getDate_TestCase_81("plan");
		String withoutDocument = Utility.getDate_TestCase_81("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_81("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_81("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_81("hours");
		String leftFosterCareAge = Utility.getDate_TestCase_81("leftFosterCareAge");
		String document = Utility.getDate_TestCase_81("document");
		String documentType = Utility.getDate_TestCase_81("documentType");
...
//		String s027QuestionMale = "Does " + applicantFullName + " " + Utility.getFromTextProperties("s027QuestionMale") + " " + "2024" + "?";
		...
		String s049QuestionMedicad = Utility.getFromTextProperties("s049QuestionMedicad3");
