...
public class TestCase_40 extends BaseTest {
	@Test
	public void TestCase_40() throws Exception {

		ExtentTestManager.createTest("Test case 40", "Test case 40");
		String tcDataFile = "partner_40.properties";
...
//		commonMethodPage.refreshPage();
		...
		*/
		...
		commonMethodPage.selectGender(female);
		commonMethodPage.selectRelation(spouseRelationship, "No applicable", "not applicable", "1");
		commonMethodPage.selectRelation(spouseRelationship, parentRelationship, "not applicable", "2");
		commonMethodPage.clickSaveAndContinueButton();
