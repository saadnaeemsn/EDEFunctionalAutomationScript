...
public class TestCase_55 extends BaseTest {
	@Test
	public void testCase_55() throws Exception {

		ExtentTestManager.createTest("Test case 55", "Test case 55");
		...
		String state = Utility.getDate_TestCase55("state");
		String firstName = Utility.getDate_TestCase55("firstName");
		String lastName = Utility.getDate_TestCase55("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase55("age");
		String streetAddress = Utility.getDate_TestCase55("streetAddress");
		String city = Utility.getDate_TestCase55("city");
		String zipCode = Utility.getDate_TestCase55("zipCode");
		String county = Utility.getDate_TestCase55("county");
		String phoneNumber = Utility.getDate_TestCase55("phoneNumber");
		String phoneType = Utility.getDate_TestCase55("phoneType");
		String SSN = Utility.getDate_TestCase55("SSN");
		String spouseSSN = Utility.getDate_TestCase55("spouseSSN");
		String relationShip = Utility.getDate_TestCase55("relationShip");
		String spouseFirstName = Utility.getDate_TestCase55("spouseFirstName");
		String spouseAge = Utility.getDate_TestCase55("spouseAge");
		String spouseLastName = Utility.getDate_TestCase55("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase55("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase55("babyCount");
		String inc = Utility.getDate_TestCase55("inc");
		String fooster = Utility.getDate_TestCase55("fooster");
		String pragnent = Utility.getDate_TestCase55("pragnent");
		String incomeAmount = Utility.getDate_TestCase55("incomeAmount");
		String incomeType = Utility.getDate_TestCase55("incomeType");
		String employerName = Utility.getDate_TestCase55("employerName");
		String incomePeriod = Utility.getDate_TestCase55("incomePeriod");
		String EmployerPhone = Utility.getDate_TestCase55("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase55("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase55("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase55("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase55("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase55("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase55("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase55("secondChildAge");
		String thirdChildFirstName = Utility.getDate_TestCase55("thirdChildFirstName");
		String thirdChildLastName = Utility.getDate_TestCase55("thirdChildLastName");
		String thirdChildFullName = thirdChildFirstName + " " + thirdChildLastName;
		String thirdChildAge = Utility.getDate_TestCase55("thirdChildAge");
		String childRelationShip = Utility.getDate_TestCase55("childRelationShip");
		String plan = Utility.getDate_TestCase55("plan");
		String fAge = Utility.getDate_TestCase55("fAge");
		String otherCoverage = Utility.getDate_TestCase55("otherCoverage");
		String brotherRelation = Utility.getDate_TestCase55("brotherRelation");
		...
		commonMethodPage.selectGender(male);
		commonMethodPage.selectRelation1_L(childRelationShip, childRelationShip, brotherRelation, brotherRelation,
				"4");
		...
		commonMethodPage.selectSitutionHouseHold_S050A(inc);
		commonMethodPage.selectSitutionHouseHold_S050A(fooster);
		...
		//commonMethodPage.verifyS050A(s050AQuestion);
		Wait.wait2Second();
		commonMethodPage.whoIsPregnant_S053(secondChildFullName);
		...
		//commonMethodPage.verifyS050A(s050AQuestion);
		Wait.wait2Second();
		commonMethodPage.whoIsInFosterCare_S054(firstChildFullName);
		commonMethodPage.selectFosterCareState(state);
		commonMethodPage.receivingMedicaidWhileFosterCare_S054(yes);
		commonMethodPage.enterAgeFosterCareLeft(fAge);
		commonMethodPage.clickSaveAndContinueButton();
		...
		commonMethodPage.whoIsIncarcerated_S094(firstChildFullName);
		commonMethodPage.whoIsIncarcerated_S094(secondChildFullName);
		commonMethodPage.whoIsIncarcerated_S094(thirdChildFullName);
		commonMethodPage.incarceratedPendingDisposition_S094_P1(yes);
		commonMethodPage.incarceratedPendingDisposition_S094_P2(yes);
		commonMethodPage.incarceratedPendingDisposition_S094_P3(yes);
		commonMethodPage.incarceratedPendingDisposition_S094_P4(yes);
		commonMethodPage.clickSaveAndContinueButton();
