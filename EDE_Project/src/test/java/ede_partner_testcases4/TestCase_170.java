...
public class TestCase_170 extends BaseTest {
	@Test
	public void testCase_170() throws Exception {

		ExtentTestManager.createTest("Test case 170", "Test case 170");
		...
		// Get data from testcase_170.properties
		String state = Utility.getDate_TestCase170("state");
		String firstName = Utility.getDate_TestCase170("firstName");
		String lastName = Utility.getDate_TestCase170("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase170("age");
		String streetAddress = Utility.getDate_TestCase170("streetAddress");
		String city = Utility.getDate_TestCase170("city");
		String zipCode = Utility.getDate_TestCase170("zipCode");
		String county = Utility.getDate_TestCase170("county");
		String phoneNumber = Utility.getDate_TestCase170("phoneNumber");
		String phoneType = Utility.getDate_TestCase170("phoneType");
		String SSN = Utility.getDate_TestCase170("SSN");
		String spouseSSN = Utility.getDate_TestCase170("spouseSSN");
		String relationShip = Utility.getDate_TestCase170("relationShip");
		String spouseFirstName = Utility.getDate_TestCase170("spouseFirstName");
		String spouseAge = Utility.getDate_TestCase170("spouseAge");
		String spouseLastName = Utility.getDate_TestCase170("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase170("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase170("babyCount");
		...
		String spouseIncomeAmount = Utility.getDate_TestCase170("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase170("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase170("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase170("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase170("employerPhone");
		String gotMarried = Utility.getDate_TestCase170("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase170("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase170("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase170("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase170("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase170("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase170("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase170("childRelationShip");
		String plan = Utility.getDate_TestCase170("plan");
		String brotherRelation = Utility.getDate_TestCase170("brotherRelation");
