...
public class TestCase_186 extends BaseTest {
	@Test
	public void testCase_186() throws Exception {

		ExtentTestManager.createTest("Test case 186", "Test case 186");
		...
		// Get data from testcase_186.properties
		String state = Utility.getDate_TestCase186("state");
		String firstName = Utility.getDate_TestCase186("firstName");
		String lastName = Utility.getDate_TestCase186("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase186("age");
		String streetAddress = Utility.getDate_TestCase186("streetAddress");
		String city = Utility.getDate_TestCase186("city");
		String OtherStreetAddress = Utility.getDate_TestCase186("OtherStreetAddress");
		String OtherCity = Utility.getDate_TestCase186("OtherCity");
		String zipCode = Utility.getDate_TestCase186("zipCode");
		String otherZipCode = Utility.getDate_TestCase186("otherZipCode");
		String county = Utility.getDate_TestCase186("county");
		String phoneNumber = Utility.getDate_TestCase186("phoneNumber");
		String phoneType = Utility.getDate_TestCase186("phoneType");
		String SSN = Utility.getDate_TestCase186("SSN");
		String spouseSSN = Utility.getDate_TestCase186("spouseSSN");
		String relationShip = Utility.getDate_TestCase186("relationShip");
		String spouseFirstName = Utility.getDate_TestCase186("spouseFirstName");
		String incomeAmount = Utility.getDate_TestCase186("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase186("selfOnlyPremiumAmount");
		String familypremiumAmount = Utility.getDate_TestCase186("familypremiumAmount");
		String incomeType = Utility.getDate_TestCase186("incomeType");
		String employerName = Utility.getDate_TestCase186("employerName");
		String incomePeriod = Utility.getDate_TestCase186("incomePeriod");
		String spouseAge = Utility.getDate_TestCase186("spouseAge");
		String spouseLastName = Utility.getDate_TestCase186("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String newphewFirstName = Utility.getDate_TestCase186("newphewFirstName");
		String newphewAge = Utility.getDate_TestCase186("newphewAge");
		String newphewLastName = Utility.getDate_TestCase186("newphewLastName");
		String newphewFullName = newphewFirstName + " " + newphewLastName;
		String s050OptionPregnant = Utility.getDate_TestCase186("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase186("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase186("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase186("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase186("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase186("spouseIncomePeriod");
		
		String firstChildIncomeAmount = Utility.getDate_TestCase186("firstChildIncomeAmount");
		String firstChildIncomeType = Utility.getDate_TestCase186("firstChildIncomeType");
		String firstChildEmployerName = Utility.getDate_TestCase186("firstChildEmployerName");
		String firstChildIncomePeriod = Utility.getDate_TestCase186("firstChildIncomePeriod");
		
		String secondChildIncomeAmount = Utility.getDate_TestCase186("secondChildIncomeAmount");
		String secondChildIncomeType = Utility.getDate_TestCase186("secondChildIncomeType");
		String secondChildEmployerName = Utility.getDate_TestCase186("secondChildEmployerName");
		String secondChildIncomePeriod = Utility.getDate_TestCase186("secondChildIncomePeriod");
		
		String EmployerPhone = Utility.getDate_TestCase186("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase186("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase186("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase186("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase186("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase186("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase186("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase186("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase186("childRelationShip");
		String plan = Utility.getDate_TestCase186("plan");
		String brotherRelation = Utility.getDate_TestCase186("brotherRelation");
		String otherRelationShip = Utility.getDate_TestCase186("otherRelationShip");
		String parentRelation = Utility.getDate_TestCase186("parentRelation");
		String parentRelationSecond = Utility.getDate_TestCase186("parentRelationSecond");
		...
		Wait.wait3Second();
		commonMethodPage.selectRelation3G_S28(parentRelation, "not applicable", "not applicable", "not applicable", "1");
		Wait.wait3Second();
		commonMethodPage.selectDoTheyLiveTogather(yes);
