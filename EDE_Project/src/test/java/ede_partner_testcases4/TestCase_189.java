...
public class TestCase_189  extends BaseTest {
	
	@Test
	public void testCase_189() throws Exception {


		ExtentTestManager.createTest("Test case 189", "Test case 189");
		...
		// Get data from data.properties
				...
				// Get data from testcase_189.properties
				String state = Utility.getDate_TestCase189("state");
				String firstName = Utility.getDate_TestCase189("firstName");
				String lastName = Utility.getDate_TestCase189("lastName");
				String applicantFullName = firstName + " " + lastName;
				String age = Utility.getDate_TestCase189("age");
				String firstCousinFirstName = Utility.getDate_TestCase189("firstCousinFirstName");
				String firstCousinLastName = Utility.getDate_TestCase189("firstCousinLastName");
				String firstCousinFullName = firstCousinFirstName + " " + firstCousinLastName;
				String firstCousinAge = Utility.getDate_TestCase189("firstCousinAge");
				String streetAddress = Utility.getDate_TestCase189("streetAddress");
				String city = Utility.getDate_TestCase189("city");
				String zipCode = Utility.getDate_TestCase189("zipCode");
				String county = Utility.getDate_TestCase189("county");
				String phoneNumber = Utility.getDate_TestCase189("phoneNumber");
				String phoneType = Utility.getDate_TestCase189("phoneType");
				String SSN = Utility.getDate_TestCase189("SSN");
				String spouseSSN = Utility.getDate_TestCase189("spouseSSN");
				String childSSN = Utility.getDate_TestCase189("childSSN");
				String isPregnant = Utility.getDate_TestCase189("isPregnant");
				String babyCount = Utility.getDate_TestCase189("babyCount");
				String domesticPartnerFirstName = Utility.getDate_TestCase189("domesticPartnerFirstName");
				String domesticPartnerLastName = Utility.getDate_TestCase189("domesticPartnerLastName");
				String domesticPartnerFullName = domesticPartnerFirstName + " " + domesticPartnerLastName;
				String domesticPartnerAge = Utility.getDate_TestCase189("domesticPartnerAge");
				String incomeAmount = Utility.getDate_TestCase189("incomeAmount");
				String selfPremiumAmount = Utility.getDate_TestCase189("selfOnlyPremiumAmount");
				String familypremiumAmount = Utility.getDate_TestCase189("familypremiumAmount");
				String incomeType = Utility.getDate_TestCase189("incomeType");
				String employerName = Utility.getDate_TestCase189("employerName");
				String incomePeriod = Utility.getDate_TestCase189("incomePeriod");
				String coverageType = Utility.getDate_TestCase189("coverageType");
				String anotherincomeAmount = Utility.getDate_TestCase189("anotherincomeAmount");
				String anotherincomeType = Utility.getDate_TestCase189("anotherincomeType");
				String anotheremployerName = Utility.getDate_TestCase189("anotheremployerName");
				String anotherincomePeriod = Utility.getDate_TestCase189("anotherincomePeriod");
				String premiumAmountPeriod = Utility.getDate_TestCase189("premiumAmountPeriod");
				String jobStartDate = Utility.getDate_TestCase189("jobStartDate");
				String jobEndDate = Utility.getDate_TestCase189("jobEndDate");
				String jobNoticeDate = Utility.getDate_TestCase189("jobNoticeDate");
				String domesticPartnerIncomeAmount = Utility.getDate_TestCase189("domesticPartnerIncomeAmount");
				String domesticPartnerIncomeType = Utility.getDate_TestCase189("domesticPartnerIncomeType");
				String domesticPartnerEmployerName = Utility.getDate_TestCase189("domesticPartnerEmployerName");
				String domesticPartnerIncomePeriod = Utility.getDate_TestCase189("domesticPartnerIncomePeriod");
				String relationShip = Utility.getDate_TestCase189("relationShip");
				String spouseFirstName = Utility.getDate_TestCase189("spouseFirstName");
				String spouseLastName = Utility.getDate_TestCase189("spouseLastName");
				String spouseAge = Utility.getDate_TestCase189("spouseAge");
				String spouseFullName = spouseFirstName + " " + spouseLastName;
				String EmployerPhone = Utility.getDate_TestCase189("EmployerPhone");
				String gotMarried = Utility.getDate_TestCase189("gotMarried");
				String childFirstName = Utility.getDate_TestCase189("childFirstName");
				String childLastName = Utility.getDate_TestCase189("childLastName");
				String childFullName = childFirstName + " " + childLastName;
				String childAge = Utility.getDate_TestCase189("childAge");
				String childRelationShip = Utility.getDate_TestCase189("childRelationShip");
				String plan = Utility.getDate_TestCase189("plan");
				String withoutDocument = Utility.getDate_TestCase189("withoutDocument");
				String childIncomeAmount = Utility.getDate_TestCase189("childIncomeAmount");
				String anualPredictedAmount = Utility.getDate_TestCase189("anualPredictedAmount");
				String hours = Utility.getDate_TestCase189("hours");
			...
			////	commonMethodPage.verifyS027(s027QuestionMale, s027DrawerHeading, s027DrawerContent);
				...
				commonMethodPage.selectSitutionHouseHold_S050A(isPregnant);
				commonMethodPage.clickSaveAndContinueButton();
