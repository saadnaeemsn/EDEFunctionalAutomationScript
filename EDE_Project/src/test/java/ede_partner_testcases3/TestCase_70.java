...
public class TestCase_70 extends BaseTest{
	@Test
	public void testCase_70() throws Exception {


		ExtentTestManager.createTest("Test case 70", "Test case 70");
		...
		String state = Utility.getDate_TestCase_70("state");
		String fosterCareState = Utility.getDate_TestCase_70("fosterCareState");
		String firstName = Utility.getDate_TestCase_70("firstName");
		String lastName = Utility.getDate_TestCase_70("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase_70("age");
		String streetAddress = Utility.getDate_TestCase_70("streetAddress");
		String city = Utility.getDate_TestCase_70("city");
		String zipCode = Utility.getDate_TestCase_70("zipCode");
		String county = Utility.getDate_TestCase_70("county");

		String tempStreetAddress = Utility.getDate_TestCase_70("tempStreetAddress");
		String tempCity = Utility.getDate_TestCase_70("tempCity");
		String tempZipCode = Utility.getDate_TestCase_70("tempZipCode");
		String tempCounty = Utility.getDate_TestCase_70("tempCounty");
		String tempState = Utility.getDate_TestCase_70("tempState");

		String otherAddress = Utility.getDate_TestCase_70("otherAddress");
		String parentStreetAddress = Utility.getDate_TestCase_70("parentStreetAddress");
		String parentCity = Utility.getDate_TestCase_70("parentCity");
		String parentZipCode = Utility.getDate_TestCase_70("parentZipCode");
		String parentCounty = Utility.getDate_TestCase_70("parentCounty");
		String parentState = Utility.getDate_TestCase_70("parentState");

		String phoneNumber = Utility.getDate_TestCase_70("phoneNumber");
		String phoneType = Utility.getDate_TestCase_70("phoneType");
		String SSN = Utility.getDate_TestCase_70("SSN");
		String spouseSSN = Utility.getDate_TestCase_70("spouseSSN");
		String childSSN = Utility.getDate_TestCase_70("childSSN");
		String parentFirstName = Utility.getDate_TestCase_70("parentFirstName");
		String parentLastName = Utility.getDate_TestCase_70("parentLastName");
		String parentFullName = parentFirstName + " " + parentLastName;
		String parentAge = Utility.getDate_TestCase_70("parentAge");
		String incomeAmount = Utility.getDate_TestCase_70("incomeAmount");
		String selfPremiumAmount = Utility.getDate_TestCase_70("selfOnlyPremiumAmount");
		String incomeType = Utility.getDate_TestCase_70("incomeType");
		String employerName = Utility.getDate_TestCase_70("employerName");
		String incomePeriod = Utility.getDate_TestCase_70("incomePeriod");
		String parentIncomeAmount = Utility.getDate_TestCase_70("parentIncomeAmount");
		String parentIncomeType = Utility.getDate_TestCase_70("parentIncomeType");
		String parentEmployerName = Utility.getDate_TestCase_70("parentEmployerName");
		String parentIncomePeriod = Utility.getDate_TestCase_70("parentIncomePeriod");
		String relationShip = Utility.getDate_TestCase_70("relationShip");
		String spouseFirstName = Utility.getDate_TestCase_70("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase_70("spouseLastName");
		String spouseAge = Utility.getDate_TestCase_70("spouseAge");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String EmployerPhone = Utility.getDate_TestCase_70("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase_70("gotMarried");
		String childFirstName = Utility.getDate_TestCase_70("childFirstName");
		String childLastName = Utility.getDate_TestCase_70("childLastName");
		String childFullName = childFirstName + " " + childLastName;
		String childAge = Utility.getDate_TestCase_70("childAge");
		String childRelationShip = Utility.getDate_TestCase_70("childRelationShip");
		String plan = Utility.getDate_TestCase_70("plan");
		String withoutDocument = Utility.getDate_TestCase_70("withoutDocument");
		String childIncomeAmount = Utility.getDate_TestCase_70("childIncomeAmount");
		String anualPredictedAmount = Utility.getDate_TestCase_70("anualPredictedAmount");
		String hours = Utility.getDate_TestCase_70("hours");
		String leftFosterCareAge = Utility.getDate_TestCase_70("leftFosterCareAge");
		...
		commonMethodPage.enterStreetAddress(tempStreetAddress);
		commonMethodPage.verifyS002(s002Question);
		commonMethodPage.selectStateInContactInfo(tempState);
		commonMethodPage.enterCity(tempCity);
		commonMethodPage.enterZipCode(tempZipCode);
		commonMethodPage.clickCountyDropDown();
		commonMethodPage.selectCounty(tempCounty);
		commonMethodPage.clickSaveAndContinueButton();
		if (!state.equals("WI")) {
		...
		commonMethodPage.enterDob(parentAge);
		commonMethodPage.enterFirstName(parentFirstName);
		commonMethodPage.enterLastName(parentLastName);
		...
		commonMethodPage.liveWithOtherParent_S031(no,"2");
		commonMethodPage.clickSaveAndContinueButton();

		//Tax Filer marital Status
		...
		commonMethodPage.selectEveryOneWhoLiveAtThisAddress_S041A(noneOfThese);
		commonMethodPage.clickSaveAndContinueButton();
		...
		Wait.wait2Second();
		commonMethodPage.enterStreetAddress_S042(streetAddress);
		...
		commonMethodPage.verifyS012(s013Question);
		commonMethodPage.clickWithOutSSN();
		commonMethodPage.clickSaveAndContinueButton();
		commonMethodPage.clickContinueWithoutSsnBtn();


		// Parent living address
		...
		commonMethodPage.whoIsFullTimeStudent_S051(applicantFullName);
		...
		commonMethodPage.verifyS057QuestionHaveIncomeThisMonth(s057QuestionParent);
		commonMethodPage.incomeThisMonth_S057(yes);
		commonMethodPage.verifyS057Question2IncomeType(s057Question2Parent);
		commonMethodPage.selectIncomeType(incomeType);
		commonMethodPage.enterEmployerName(employerName);
		commonMethodPage.verifyS057Question3IncomeDuration(s057Question3Parent);
		...
		ExtentTestManager.getTest().info("---------------------SCREEN S058----------------------------");
		commonMethodPage.verifyS058(s058QuestionParent);
		commonMethodPage.expenseDecision_S058(no);
		commonMethodPage.clickSaveAndContinueButton();
