...
//		String s015Question = "Does this match the name and date of birth on "+applicantFullName+"'s Social Security card?";
		...
		String s049QuestionMedicad1 = "Did " + applicantFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
		String s049QuestionMedicad2 = "Did " + spouseFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
		String s049QuestionMedicad3 = "Did " + firstChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
		String s049QuestionMedicad4 = "Did " + secondChildFullName + " " + Utility.getFromTextProperties("s049QuestionMedicadOR");
...
//				commonMethodPage.verifyS038(s038Question2);
		...
		commonMethodPage.verifyPTC107S046(s046QuestionMedicadOR);
		commonMethodPage.chooseAnOption(noneOfThesePeople, 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
...
//		commonMethodPage.chooseAnOption("I agree to allow the", 1, 1);
		commonMethodPage.clickSaveAndContinueButton();
