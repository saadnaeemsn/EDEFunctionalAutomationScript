...
public class TestCase_167 extends BaseTest {
	@Test
	public void testCase_167() throws Exception {

		ExtentTestManager.createTest("PTC 167", "Partner Test Case 167");
		...
		String state = Utility.getDate_TestCase167("state");
		String firstName = Utility.getDate_TestCase167("firstName");
		String lastName = Utility.getDate_TestCase167("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase167("age");
		String streetAddress = Utility.getDate_TestCase167("streetAddress");
		String city = Utility.getDate_TestCase167("city");
		String zipCode = Utility.getDate_TestCase167("zipCode");
		String county = Utility.getDate_TestCase167("county");
		String phoneNumber = Utility.getDate_TestCase167("phoneNumber");
		String phoneType = Utility.getDate_TestCase167("phoneType");
		String SSN = Utility.getDate_TestCase167("SSN");
		String spouseSSN = Utility.getDate_TestCase167("spouseSSN");
		String relationShip = Utility.getDate_TestCase167("relationShip");
		String spouseFirstName = Utility.getDate_TestCase167("spouseFirstName");
		String spouseLastName = Utility.getDate_TestCase167("spouseLastName");
		String spouseFullName = spouseFirstName + " " + spouseLastName;
		String s050OptionPregnant = Utility.getDate_TestCase167("s050OptionPregnant");
		String babyCount = Utility.getDate_TestCase167("babyCount");
		String spouseIncomeAmount = Utility.getDate_TestCase167("spouseIncomeAmount");
		String spouseIncomeType = Utility.getDate_TestCase167("spouseIncomeType");
		String spouseEmployerName = Utility.getDate_TestCase167("spouseEmployerName");
		String spouseIncomePeriod = Utility.getDate_TestCase167("spouseIncomePeriod");
		String EmployerPhone = Utility.getDate_TestCase167("EmployerPhone");
		String gotMarried = Utility.getDate_TestCase167("gotMarried");
		String firstChildFirstName = Utility.getDate_TestCase167("firstChildFirstName");
		String firstChildLastName = Utility.getDate_TestCase167("firstChildLastName");
		String firstChildFullName = firstChildFirstName + " " + firstChildLastName;
		String firstChildAge = Utility.getDate_TestCase167("firstChildAge");
		String secondChildFirstName = Utility.getDate_TestCase167("secondChildFirstName");
		String secondChildLastName = Utility.getDate_TestCase167("secondChildLastName");
		String secondChildFullName = secondChildFirstName + " " + secondChildLastName;
		String secondChildAge = Utility.getDate_TestCase167("secondChildAge");
		String childRelationShip = Utility.getDate_TestCase167("childRelationShip");
		String plan = Utility.getDate_TestCase167("plan");
		String brotherRelation = Utility.getDate_TestCase167("brotherRelation");
...
//		Wait.wait5Second();
		...
		commonMethodPage.stateBenifitPlanThroughJob_PTC167S082(firstChildFullName);
		commonMethodPage.stateBenifitPlanThroughJob_PTC167S082(secondChildFullName);
		commonMethodPage.clickSaveAndContinueButton();
