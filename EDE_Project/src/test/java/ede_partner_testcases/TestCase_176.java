...
public class TestCase_176 extends BaseTest {
	@Test
	public void estCase_176() throws Exception {
		...
		String state = Utility.getDate_TestCase176("state");
		String firstName = Utility.getDate_TestCase176("firstName");
		String lastName = Utility.getDate_TestCase176("lastName");
		String applicantFullName = firstName + " " + lastName;
		String age = Utility.getDate_TestCase176("age");
		String streetAddress = Utility.getDate_TestCase176("streetAddress");
		String city = Utility.getDate_TestCase176("city");
		String zipCode = Utility.getDate_TestCase176("zipCode");
		String county = Utility.getDate_TestCase176("county");
		String phoneNumber = Utility.getDate_TestCase176("phoneNumber");
		String phoneType = Utility.getDate_TestCase176("phoneType");
		String document = Utility.getDate_TestCase176("document");
		String documentType = Utility.getDate_TestCase176("documentType");
		String incomeAmount = Utility.getDate_TestCase176("incomeAmount");
		String incomeType = Utility.getDate_TestCase176("incomeType");
		String employerName = Utility.getDate_TestCase176("employerName");
		String incomePeriod = Utility.getDate_TestCase176("incomePeriod");
		String EmployerPhone = Utility.getDate_TestCase176("EmployerPhone");
...
//			commonMethodPage.selectAddress();
		...
		commonMethodPage.changeimmigrationStatusDueToNonEligibleForMedicaidCHIP_PTC176S050(no);
		commonMethodPage.clickSaveAndContinueButton();
